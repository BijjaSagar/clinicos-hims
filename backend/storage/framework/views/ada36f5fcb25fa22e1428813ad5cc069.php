...
<?php $__env->startSection('breadcrumb', 'Schedule / New Appointment'); ?>
...
<div class="booking-container" x-data="appointmentForm()">
    <div class="booking-card">
        ...
        <form action="<?php echo e(route('appointments.store')); ?>" method="POST" class="booking-body">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div style="margin-top:8px">
                    <a href="<?php echo e(route('patients.create')); ?>" style="font-size:12px;color:#1447e6;text-decoration:none">
            ...
            <div class="form-section">
                ...
                <div class="doctor-cards">
                    ...
                    <div class="doctor-card" :class="{ 'selected': selectedDoctor === <?php echo e($doctor->id); ?> }" @click="selectedDoctor = <?php echo e($doctor->id); ?>">
                        <div class="doctor-avatar"><?php echo e(substr($doctor->name, 0, 1)); ?></div>
                        <div class="doctor-info">
                            <h4>Dr. <?php echo e($doctor->name); ?></h4>
                            <p><?php echo e($doctor->specialty ?? 'General'); ?></p>
                        </div>
                    </div>
                ...
                <div class="form-grid">
                    <div class="form-group">
                        ...
                        <input type="date" name="scheduled_date" class="form-input" 
                               ...
                               value="<?php echo e(request('date', today()->toDateString())); ?>" 
                               required>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group" style="margin-top:12px">
                    ...
                    <div class="time-slots">
                        ...
                        <div class="time-slot" 
                             :class="{ 'selected': selectedTime === '<?php echo e($slot); ?>' }"
                             @click="selectedTime = '<?php echo e($slot); ?>'">
                            <?php echo e(\Carbon\Carbon::parse($slot)->format('h:i A')); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <?php if($rooms->isNotEmpty() || $equipment->isNotEmpty()): ?>
            <div class="form-section">
                <div class="form-section-title">
                    <svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                ...
                <div class="form-group">
                    ...
                    <div class="resource-grid">
                        ...
                        <div class="resource-chip" :class="{ 'selected': selectedRoom === <?php echo e($room->id); ?> }" @click="selectedRoom = <?php echo e($room->id); ?>">
                ...
                <div class="form-group" style="margin-top:12px">
                    ...
                    <div class="resource-grid">
                        ...
                        <div class="resource-chip" :class="{ 'selected': selectedEquipment === <?php echo e($equip->id); ?> }" @click="selectedEquipment = <?php echo e($equip->id); ?>">
            ...
            <div class="form-section">
                ...
                <div class="form-group">
                    ...
                    <select name="location_id" class="form-select">
                        ...
                        <option value="<?php echo e($loc->id); ?>"><?php echo e($loc->name); ?><?php if(!empty($loc->is_primary)): ?> (Primary)<?php endif; ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
            </div>
            ...
            <div class="booking-actions">
                <a href="<?php echo e(route('schedule')); ?>" class="btn btn-secondary">Cancel</a>
...
function appointmentForm() {
    return {
        ...
        filteredPatients: [],
        allPatients: <?php echo json_encode($patients, 15, 512) ?>,
        
        appointmentType: '<?php echo e(request('type', 'new')); ?>',
        selectedDoctor: <?php echo e(request('doctor', $doctors->first()->id ?? 'null')); ?>,
        selectedDate: '<?php echo e(request('date', today()->toDateString())); ?>',
        selectedTime: '<?php echo e(request('time', '09:00')); ?>',
        duration: '30',
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/akash/Downloads/clinicos-main/backend/resources/views/appointments/create.blade.php ENDPATH**/ ?>