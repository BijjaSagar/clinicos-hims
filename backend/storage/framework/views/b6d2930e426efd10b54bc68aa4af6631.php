...
function oncologyEMR() {
    return {
        ...
        formData: <?php echo json_encode(($visit ?? null)?->getStructuredField('oncology_data') ?? $oncologyFormDataDefault, 15, 512) ?>,
        commonDiagnoses: [
        ...
        selectedDiagnoses: <?php echo json_encode(($visit ?? null)?->getStructuredField('oncology_diagnoses') ?? [], 15, 512) ?>,
...
<?php /**PATH /Users/akash/Downloads/clinicos-main/backend/resources/views/emr/specialty/oncology.blade.php ENDPATH**/ ?>