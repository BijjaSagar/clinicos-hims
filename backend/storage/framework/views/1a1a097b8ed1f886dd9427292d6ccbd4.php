...
<?php $__env->startSection('subtitle', 'Manage plans and billing'); ?>
...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div class="bg-white rounded-2xl p-6 border border-slate-100 card-hover">
            ...
            <div class="pt-4 border-t border-slate-100">
                <div class="flex items-center justify-between text-sm">
                    ...
                    <span class="font-bold text-slate-900"><?php echo e($clinicsByPlan['trial'] ?? 0); ?></span>
                </div>
            </div>
        ...
        <div class="bg-white rounded-2xl p-6 border border-slate-100 card-hover">
            ...
            <div class="pt-4 border-t border-slate-100">
                <div class="flex items-center justify-between text-sm">
                    <span class="text-slate-500">Active clinics</span>
                    <span class="font-bold text-slate-900"><?php echo e($clinicsByPlan['solo'] ?? 0); ?></span>
                </div>
            </div>
            <ul class="mt-4 space-y-2 text-sm text-slate-600">
                <li class="flex items-center gap-2"><span class="text-emerald-500">✓</span> 1 Doctor</li>
        ...
        <div class="bg-white rounded-2xl p-6 border-2 border-emerald-500 relative card-hover">
            ...
            <div class="pt-4 border-t border-slate-100">
                <div class="flex items-center justify-between text-sm">
                    <span class="text-slate-500">Active clinics</span>
                    <span class="font-bold text-slate-900"><?php echo e($clinicsByPlan['small'] ?? 0); ?></span>
                </div>
            </div>
            <ul class="mt-4 space-y-2 text-sm text-slate-600">
        ...
        <div class="bg-white rounded-2xl p-6 border border-slate-100 card-hover">
            ...
            <div class="pt-4 border-t border-slate-100">
                <div class="flex items-center justify-between text-sm">
                    <span class="text-slate-500">Active clinics</span>
                    <span class="font-bold text-slate-900"><?php echo e($clinicsByPlan['enterprise'] ?? 0); ?></span>
                </div>
            </div>
            <ul class="mt-4 space-y-2 text-sm text-slate-600">
        ...
        <div class="bg-white rounded-2xl p-6 border border-slate-100 card-hover">
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-3xl font-display font-bold text-slate-900">₹<?php echo e(number_format($mrr)); ?></p>
                </div>
            </div>
        </div>
        <div class="bg-white rounded-2xl p-6 border border-slate-100 card-hover">
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-3xl font-display font-bold text-slate-900">₹<?php echo e(number_format($arr)); ?></p>
                </div>
            </div>
        </div>
        <div class="bg-white rounded-2xl p-6 border border-slate-100 card-hover">
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-3xl font-display font-bold text-slate-900"><?php echo e($activeTrials); ?></p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="bg-white rounded-2xl border border-slate-100 overflow-hidden">
            <div class="px-6 py-4 border-b border-slate-100 flex items-center justify-between">
                ...
                <span class="px-3 py-1 text-xs font-semibold bg-emerald-100 text-emerald-700 rounded-full"><?php echo e($paidClinics->count()); ?> active</span>
            </div>
            <div class="divide-y divide-slate-100 max-h-96 overflow-y-auto">
                <?php $__empty_1 = true; $__currentLoopData = $paidClinics; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $clinic): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="px-6 py-4 flex items-center justify-between hover:bg-slate-50 transition-colors" x-data="{ showPlanModal: false }">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <p class="text-sm font-medium text-slate-900"><?php echo e($clinic->name); ?></p>
                            <p class="text-xs text-slate-500"><?php echo e($clinic->owner?->email ?? 'No owner'); ?></p>
                        </div>
                    </div>
                    <div class="flex items-center gap-3">
                        <span class="px-2 py-1 text-xs font-semibold rounded-full
                            <?php if($clinic->plan === 'solo'): ?> bg-blue-100 text-blue-700
                            <?php elseif($clinic->plan === 'small'): ?> bg-emerald-100 text-emerald-700
                    ...
                    <div x-show="showPlanModal" x-cloak class="fixed inset-0 z-50 flex items-center justify-center" @keydown.escape.window="showPlanModal = false">
                        ...
                        <div class="relative bg-white rounded-2xl shadow-xl p-6 max-w-sm mx-4 w-full" @click.stop>
                            <h3 class="text-lg font-semibold text-slate-900 mb-4">Change Plan for <?php echo e($clinic->name); ?></h3>
                            <form action="<?php echo e(route('admin.subscriptions.update-plan', $clinic)); ?>" method="POST">
                                <?php echo csrf_field(); ?>
                                <select name="plan" class="w-full px-4 py-2.5 rounded-xl border border-slate-300 focus:ring-2 focus:ring-indigo-500 mb-4">
                                    <option value="trial" <?php echo e($clinic->plan === 'trial' ? 'selected' : ''); ?>>Trial</option>
                                    <option value="solo" <?php echo e($clinic->plan === 'solo' ? 'selected' : ''); ?>>Solo - ₹999/mo</option>
                                    <option value="small" <?php echo e($clinic->plan === 'small' ? 'selected' : ''); ?>>Small - ₹2,499/mo</option>
                                    <option value="group" <?php echo e($clinic->plan === 'group' ? 'selected' : ''); ?>>Group - ₹4,999/mo</option>
                                    <option value="enterprise" <?php echo e($clinic->plan === 'enterprise' ? 'selected' : ''); ?>>Enterprise</option>
                                </select>
        ...
        <div class="bg-white rounded-2xl border border-slate-100 overflow-hidden">
            ...
            <div class="divide-y divide-slate-100 max-h-96 overflow-y-auto">
                <?php $__empty_1 = true; $__currentLoopData = $expiringTrials; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $clinic): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="px-6 py-4 flex items-center justify-between hover:bg-slate-50 transition-colors" x-data="{ showExtendModal: false }">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <p class="text-sm font-medium text-slate-900"><?php echo e($clinic->name); ?></p>
                            <p class="text-xs text-slate-500"><?php echo e($clinic->owner?->email ?? 'N/A'); ?></p>
                        </div>
                    </div>
                    <div class="flex items-center gap-3">
                        <div class="text-right">
                            <p class="text-sm font-medium text-amber-600"><?php echo e($clinic->trial_ends_at->diffForHumans()); ?></p>
                            <p class="text-xs text-slate-500"><?php echo e($clinic->trial_ends_at->format('d M Y')); ?></p>
                        </div>
                    ...
                    <div x-show="showExtendModal" x-cloak class="fixed inset-0 z-50 flex items-center justify-center" @keydown.escape.window="showExtendModal = false">
                        ...
                        <div class="relative bg-white rounded-2xl shadow-xl p-6 max-w-sm mx-4 w-full" @click.stop>
                            <h3 class="text-lg font-semibold text-slate-900 mb-4">Extend Trial for <?php echo e($clinic->name); ?></h3>
                            <form action="<?php echo e(route('admin.subscriptions.extend-trial', $clinic)); ?>" method="POST">
                                <?php echo csrf_field(); ?>
                                <div class="mb-4">
    ...
    <?php if($expiredTrials->isNotEmpty()): ?>
    <div class="bg-white rounded-2xl border border-slate-100 overflow-hidden">
        <div class="px-6 py-4 border-b border-slate-100 flex items-center justify-between">
            <h3 class="font-display font-bold text-slate-900">Expired Trials</h3>
            <span class="px-3 py-1 text-xs font-semibold bg-red-100 text-red-700 rounded-full"><?php echo e($expiredTrials->count()); ?> expired</span>
        </div>
        <div class="overflow-x-auto">
            <table class="w-full">
                ...
                <tbody class="divide-y divide-slate-100">
                    <?php $__currentLoopData = $expiredTrials; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $clinic): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr class="hover:bg-slate-50" x-data="{ showConvertModal: false }">
                        <td class="px-6 py-4">
                            <div class="flex items-center gap-3">
                                <div class="w-8 h-8 bg-red-100 rounded-lg flex items-center justify-center">
                                    <span class="text-red-600 font-semibold text-xs"><?php echo e(substr($clinic->name, 0, 1)); ?></span>
                                </div>
                                <span class="text-sm font-medium text-slate-900"><?php echo e($clinic->name); ?></span>
                            </div>
                        </td>
                        <td class="px-6 py-4">
                            <span class="text-sm text-slate-600"><?php echo e($clinic->owner?->email ?? 'N/A'); ?></span>
                        </td>
                        <td class="px-6 py-4">
                            <span class="text-sm text-red-600"><?php echo e($clinic->trial_ends_at->diffForHumans()); ?></span>
                        </td>
                        <td class="px-6 py-4 text-right">
                            <div class="flex items-center justify-end gap-2">
                                ...
                                <form action="<?php echo e(route('admin.subscriptions.extend-trial', $clinic)); ?>" method="POST" class="inline">
                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/akash/Downloads/clinicos-main/backend/resources/views/admin/subscriptions/index.blade.php ENDPATH**/ ?>