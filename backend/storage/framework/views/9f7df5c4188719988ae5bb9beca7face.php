<?php $__env->startSection('title', 'EMR'); ?>
<?php $__env->startSection('breadcrumb', 'Electronic Medical Records'); ?>
...
<div class="p-6 space-y-6">
    ...
    <div class="grid grid-cols-4 gap-4">
        <div class="bg-white rounded-xl p-5 border border-gray-200">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <p class="text-2xl font-bold text-gray-900"><?php echo e($stats['today_visits'] ?? 0); ?></p>
        ...
        <div class="bg-white rounded-xl p-5 border border-gray-200">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <p class="text-2xl font-bold text-gray-900"><?php echo e($stats['in_progress'] ?? 0); ?></p>
        ...
        <div class="bg-white rounded-xl p-5 border border-gray-200">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <p class="text-2xl font-bold text-gray-900"><?php echo e($stats['completed_today'] ?? 0); ?></p>
        ...
        <div class="bg-white rounded-xl p-5 border border-gray-200">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <p class="text-2xl font-bold text-gray-900"><?php echo e($stats['pending_followups'] ?? 0); ?></p>
    ...
    <div class="grid grid-cols-3 gap-6">
        ...
        <div class="col-span-2 bg-white rounded-xl border border-gray-200">
            ...
            <div class="divide-y divide-gray-100">
                <?php $__empty_1 = true; $__currentLoopData = $inProgressVisits ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $visit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <a href="<?php echo e(route('emr.show', ['patient' => $visit->patient_id, 'visit' => $visit->id])); ?>" 
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-4">
                            <div class="w-12 h-12 bg-gradient-to-br from-amber-400 to-orange-500 rounded-full flex items-center justify-center text-white font-bold text-lg">
                                <?php echo e(substr($visit->patient->name ?? 'P', 0, 1)); ?>

                            </div>
                            <div>
                                <p class="font-semibold text-gray-900"><?php echo e($visit->patient->name ?? 'Unknown'); ?></p>
                                <div class="flex items-center gap-3 mt-1">
                                    <span class="text-xs text-gray-500">
                                        <?php echo e($visit->patient->age_years ?? 'N/A'); ?><?php echo e($visit->patient->sex ? strtoupper(substr($visit->patient->sex, 0, 1)) : ''); ?>

                                    </span>
                                    <span class="text-xs text-gray-400">•</span>
                                    <span class="text-xs text-gray-500"><?php echo e($visit->chief_complaint ?? 'General Consultation'); ?></span>
                                    <span class="text-xs text-gray-400">•</span>
                                    <span class="text-xs text-gray-500">Visit #<?php echo e($visit->visit_number); ?></span>
                                </div>
                            </div>
                        </div>
                        <div class="text-right">
                            ...
                            <p class="text-xs text-gray-400 mt-1">Started <?php echo e($visit->started_at?->diffForHumans() ?? 'Just now'); ?></p>
                        </div>
                    </div>
                </a>
        ...
        <div class="bg-white rounded-xl border border-gray-200">
            ...
            <div class="divide-y divide-gray-100 max-h-80 overflow-y-auto">
                <?php $__empty_1 = true; $__currentLoopData = $todayAppointments ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $apt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-3">
                            <div class="w-9 h-9 bg-blue-100 rounded-full flex items-center justify-center text-blue-600 font-semibold text-sm">
                                <?php echo e(substr($apt->patient->name ?? 'P', 0, 1)); ?>

                            </div>
                            <div>
                                <p class="text-sm font-medium text-gray-900"><?php echo e($apt->patient->name ?? 'Unknown'); ?></p>
                                <p class="text-xs text-gray-500"><?php echo e($apt->scheduled_at?->format('h:i A')); ?> · <?php echo e(ucfirst($apt->appointment_type ?? 'consultation')); ?></p>
                            </div>
                        </div>
                        <form action="<?php echo e(route('emr.create', $apt->patient)); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                            <?php if(!empty($apt->specialty)): ?>
                                <input type="hidden" name="specialty" value="<?php echo e($apt->specialty); ?>">
                            <?php endif; ?>
            ...
            <div class="px-5 py-3 border-t border-gray-100">
                <a href="<?php echo e(route('appointments.index')); ?>" class="text-sm text-blue-600 hover:text-blue-700 font-medium">
    ...
    <div class="bg-white rounded-xl border border-gray-200">
        <div class="px-5 py-4 border-b border-gray-200 flex items-center justify-between">
            ...
            <a href="<?php echo e(route('patients.index')); ?>" class="text-sm text-blue-600 hover:text-blue-700 font-medium">
                View All Patients →
            </a>
        </div>
        <div class="divide-y divide-gray-100">
               ...
               class="block px-5 py-4 hover:bg-gray-50 transition-colors">
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <p class="font-semibold text-gray-900"><?php echo e($visit->patient->name ?? 'Unknown'); ?></p>
                            <p class="text-sm text-gray-500"><?php echo e($visit->chief_complaint ?? 'General Visit'); ?></p>
                        </div>
                    </div>
                    <div class="text-right">
                        <p class="text-sm text-gray-500"><?php echo e($visit->created_at->format('d M Y')); ?></p>
                        <span class="text-xs px-2 py-1 rounded-full 
                            <?php if($visit->status === 'finalised'): ?> bg-green-100 text-green-700
                            <?php elseif($visit->status === 'draft'): ?> bg-amber-100 text-amber-700
            ...
            <div class="px-5 py-8 text-center">
                ...
                <a href="<?php echo e(route('patients.index')); ?>" class="inline-flex items-center gap-2 px-5 py-2.5 bg-blue-600 text-white font-semibold rounded-xl hover:bg-blue-700 transition-colors">
    ...
    <div class="bg-white rounded-xl border border-gray-200 p-5">
        ...
        <div class="flex gap-4">
            <a href="<?php echo e(route('patients.index')); ?>" class="flex items-center gap-3 px-5 py-3 bg-blue-50 hover:bg-blue-100 rounded-xl transition-colors">
            ...
            <a href="<?php echo e(route('appointments.index')); ?>" class="flex items-center gap-3 px-5 py-3 bg-green-50 hover:bg-green-100 rounded-xl transition-colors">
            ...
            <a href="<?php echo e(route('prescriptions.index')); ?>" class="flex items-center gap-3 px-5 py-3 bg-purple-50 hover:bg-purple-100 rounded-xl transition-colors">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/akash/Downloads/clinicos-main/backend/resources/views/emr/index.blade.php ENDPATH**/ ?>