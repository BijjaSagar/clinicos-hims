...
<?php $__env->startSection('breadcrumb', 'Create Prescription'); ?>
...
<div class="p-6 space-y-6" x-data="prescriptionForm()">
    ...
    <div class="bg-white rounded-xl border border-gray-200 p-5">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
                ...
                <p class="text-sm text-gray-500 mt-0.5">
                    Visit #<?php echo e($visit->id); ?> &middot; <?php echo e($visit->diagnosis_text ?? 'No diagnosis recorded'); ?>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mt-5 pt-5 border-t border-gray-100">
            <div>
                ...
                <p class="text-sm font-semibold text-gray-900 mt-0.5"><?php echo e($patient->name); ?></p>
            </div>
            <div>
                <p class="text-xs text-gray-400 font-medium">Age / Gender</p>
                <p class="text-sm font-semibold text-gray-900 mt-0.5">
                    <?php echo e($patient->age_years ?? '-'); ?> yrs / <?php echo e(ucfirst($patient->sex ?? '-')); ?>

                </p>
            </div>
            <div>
                <p class="text-xs text-gray-400 font-medium">ABHA ID</p>
                <p class="text-sm font-semibold text-gray-900 mt-0.5"><?php echo e($patient->abha_id ?? 'Not linked'); ?></p>
            </div>
            <div>
                <p class="text-xs text-gray-400 font-medium">Allergies</p>
                <div class="flex flex-wrap gap-1 mt-0.5">
                    <?php if($patient->known_allergies && count($patient->known_allergies) > 0): ?>
                        <?php $__currentLoopData = $patient->known_allergies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $allergy): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <div class="bg-white rounded-xl border border-gray-200 p-5">
        ...
        <div class="flex flex-wrap gap-2">
            <?php $__currentLoopData = ['Acne Vulgaris','Eczema','Psoriasis','Fungal Infection','URI','UTI','Hypertension','Diabetes']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tmpl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <button type="button" @click="applyTemplate('<?php echo e(strtolower(str_replace(' ', '-', $tmpl))); ?>')"
    ...
    <div x-show="showTemplateModal" x-cloak
        ...
        <div class="bg-white rounded-2xl shadow-2xl w-full max-w-lg p-6">
            ...
            <div class="space-y-2 max-h-80 overflow-y-auto">
                <?php $__currentLoopData = ['Acne Vulgaris','Eczema','Psoriasis','Fungal Infection','URI','UTI','Hypertension','Diabetes']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tmpl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <button type="button"
                        @click="applyTemplate('<?php echo e(strtolower(str_replace(' ', '-', $tmpl))); ?>'); showTemplateModal = false"
                        class="w-full text-left px-4 py-3 bg-gray-50 hover:bg-blue-50 rounded-lg transition">
                    <p class="text-sm font-semibold text-gray-900"><?php echo e($tmpl); ?></p>
                    <p class="text-xs text-gray-500 mt-0.5">Pre-configured drugs for <?php echo e($tmpl); ?></p>
                </button>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
        </div>
...
function prescriptionForm() {
    return {
        ...
        patientAllergies: <?php echo json_encode($patient->known_allergies ?? [], 15, 512) ?>,

        // Drug interaction data from server
        knownInteractions: <?php echo json_encode($interactions ?? [], 15, 512) ?>,
        ...
        async savePrescription(action) {
            ...
            try {
                const payload = {
                    visit_id: <?php echo e($visit->id); ?>,
                    patient_id: <?php echo e($patient->id); ?>,
                    valid_days: 30,
                ...
                setTimeout(() => {
                    window.location.href = '<?php echo e(route("prescriptions.index")); ?>';
                }, 1500);
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/akash/Downloads/clinicos-main/backend/resources/views/prescriptions/create.blade.php ENDPATH**/ ?>