<?php $__env->startSection('title', 'Lab — Work Queue'); ?>
        ...
        <div class="relative px-5 py-6 sm:px-8 sm:py-8 flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
            ...
            <div class="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 lg:flex-shrink-0">
                <?php if(\Illuminate\Support\Facades\Route::has('laboratory.orders')): ?>
                    <a
                        href="<?php echo e(route('laboratory.orders')); ?>"
                ...
                <?php endif; ?>
                <a
                    href="<?php echo e(url('/laboratory')); ?>"
        ...
        <div class="bg-white rounded-2xl border border-gray-200 shadow-sm p-5 relative overflow-hidden">
            ...
            <div class="flex items-start justify-between pl-3">
                <div>
                    ...
                    <p class="text-3xl font-extrabold text-red-600 leading-none tabular-nums"><?php echo e($stats['pending']); ?></p>
        ...
        <div class="bg-white rounded-2xl border border-gray-200 shadow-sm p-5 relative overflow-hidden">
            ...
            <div class="flex items-start justify-between pl-3">
                <div>
                    ...
                    <p class="text-3xl font-extrabold text-amber-600 leading-none tabular-nums"><?php echo e($stats['sample_collected']); ?></p>
        ...
        <div class="bg-white rounded-2xl border border-gray-200 shadow-sm p-5 relative overflow-hidden">
            ...
            <div class="flex items-start justify-between pl-3">
                <div>
                    ...
                    <p class="text-3xl font-extrabold text-sky-600 leading-none tabular-nums"><?php echo e($stats['processing']); ?></p>
        ...
        <div class="bg-white rounded-2xl border border-gray-200 shadow-sm p-5 relative overflow-hidden">
            ...
            <div class="flex items-start justify-between pl-3">
                <div>
                    ...
                    <p class="text-3xl font-extrabold text-emerald-600 leading-none tabular-nums"><?php echo e($stats['completed_today']); ?></p>
            ...
            <div class="flex items-center gap-3">
                ...
                <?php if(!$pendingOrders->isEmpty()): ?>
                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-semibold bg-cyan-100 text-cyan-900 ring-1 ring-cyan-200/80">
                        <?php echo e($pendingOrders->count()); ?> active
                    </span>
                <?php endif; ?>
            </div>
            ...
            <div class="relative text-center py-16 sm:py-20 px-6">
                ...
                <div class="relative max-w-md mx-auto">
                    ...
                    <div class="mt-8 flex flex-col sm:flex-row items-center justify-center gap-3">
                        <a href="<?php echo e(url('/laboratory')); ?>" class="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl text-sm font-semibold text-white bg-gradient-to-r from-teal-600 to-cyan-600 hover:from-teal-700 hover:to-cyan-700 shadow-md">
                            Open laboratory
                        </a>
                        <?php if(\Illuminate\Support\Facades\Route::has('laboratory.catalog')): ?>
                            <a href="<?php echo e(route('laboratory.catalog')); ?>" class="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl text-sm font-semibold text-gray-700 bg-gray-100 hover:bg-gray-200">
                                Test catalog
                            </a>
                        <?php endif; ?>
                    </div>
                        ...
                        <?php $__currentLoopData = $pendingOrders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <tr class="hover:bg-cyan-50/40 transition-colors">
                                ...
                                <td class="px-4 py-3.5">
                                    ...
                                    <p class="text-xs text-gray-500 mt-0.5"><?php echo e($age); ?> · <?php echo e(ucfirst($order->gender ?? '—')); ?></p>
                                </td>
                                <td class="px-4 py-3.5 text-sm text-gray-700">
                                    Dr. <?php echo e($order->doctor_name); ?>
                                ...
                                <td class="px-4 py-3.5 text-sm text-gray-600 whitespace-nowrap">
                                    <?php echo e(\Carbon\Carbon::parse($order->created_at)->format('d M, H:i')); ?>
                                ...
                                <td class="px-4 py-3.5">
                                    <div class="flex items-center gap-2 flex-wrap">
                                        <?php if($order->status === 'pending'): ?>
                                            <button
                                                type="button"
                                                @click="collectModal = true; activeOrderId = <?php echo e($order->id); ?>"
                                        ...
                                        <?php elseif(in_array($order->status, ['sample_collected', 'processing'])): ?>
                                            <a
                                                href="<?php echo e(route('lab.technician.result-form', $order->id)); ?>"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/akash/Downloads/clinicos-main/backend/resources/views/lab/technician/dashboard.blade.php ENDPATH**/ ?>