...
function neurologyEMR() {
    ...
    return {
        ...
        formData: <?php echo json_encode(($visit ?? null)?->getStructuredField('neurology_data') ?? $neurologyFormDataDefault, 15, 512) ?>,
        commonDiagnoses: [
        ...
        selectedDiagnoses: <?php echo json_encode(($visit ?? null)?->getStructuredField('neurology_diagnoses') ?? [], 15, 512) ?>,
        init() {
...
<?php /**PATH /Users/akash/Downloads/clinicos-main/backend/resources/views/emr/specialty/neurology.blade.php ENDPATH**/ ?>