<?php $__env->startSection('title', 'Global WhatsApp Settings'); ?>
...
<div class="p-6 max-w-4xl mx-auto space-y-6">
    ...
    <div class="flex items-center gap-4">
        ...
        <div>
            ...
            <p class="text-gray-500 text-sm">These credentials are used by all <?php echo e($totalClinics); ?> active clinics on the platform</p>
        </div>
    ...
    <div class="px-4 py-3 rounded-xl bg-green-50 border border-green-200 text-green-800 text-sm"><?php echo e(session('success')); ?></div>
    <?php endif; ?>
    ...
    <div class="bg-white border border-gray-200 rounded-xl p-6">
        ...
        <form method="POST" action="<?php echo e(route('admin.whatsapp.save')); ?>" class="space-y-4">
            <?php echo csrf_field(); ?>
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="text" name="waba_id" value="<?php echo e(old('waba_id', $config['waba_id'])); ?>"
                        placeholder="WhatsApp Business Account ID"
                        class="w-full px-3 py-2.5 border border-gray-200 rounded-lg text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                </div>
                <div class="sm:col-span-2">
                    <label class="block text-sm font-medium text-gray-700 mb-1">Access Token <span class="text-red-500">*</span></label>
                    <input type="password" name="access_token" value="<?php echo e(old('access_token', $config['access_token'])); ?>"
                ...
                <div>
                    ...
                    <input type="password" name="app_secret" value="<?php echo e(old('app_secret', $config['app_secret'])); ?>"
                ...
                <div>
                    ...
                    <input type="text" name="verify_token" value="<?php echo e(old('verify_token', $config['verify_token'])); ?>"
                        class="w-full px-3 py-2.5 border border-gray-200 rounded-lg text-sm font-mono focus:ring-2 focus:ring-blue-500">
                </div>
            </div>
            ...
            <div class="bg-gray-50 rounded-lg p-3 text-sm">
                ...
                <code class="text-xs text-blue-700 break-all"><?php echo e($webhookUrl); ?></code>
            </div>
...
async function testWhatsApp() {
    ...
    try {
        const res = await fetch('<?php echo e(route("admin.whatsapp.test")); ?>', {
            method: 'POST',
            headers: {
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/akash/Downloads/clinicos-main/backend/resources/views/admin/whatsapp.blade.php ENDPATH**/ ?>