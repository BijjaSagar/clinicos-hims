...
function nephrologyEMR() {
    return {
        ...
        formData: <?php echo json_encode($__nephFormDataForAlpine, 15, 512) ?>,
        commonDiagnoses: [
        ...
        selectedDiagnoses: <?php echo json_encode($__nephDxForAlpine, 15, 512) ?>,
        get egfrDisplay() {
...
<?php /**PATH /Users/akash/Downloads/clinicos-main/backend/resources/views/emr/specialty/nephrology.blade.php ENDPATH**/ ?>