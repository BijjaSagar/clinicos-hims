<?php $__env->startSection('title', 'Pre-authorization'); ?>
<?php $__env->startSection('breadcrumb', 'Insurance / Pre-auth'); ?>

<?php $__env->startSection('content'); ?>
<div class="p-6 max-w-2xl mx-auto space-y-6">
    <div>
        <a href="<?php echo e(route('insurance.index')); ?>" class="text-sm text-blue-600 hover:underline">&larr; Insurance dashboard</a>
        <h1 class="text-xl font-bold text-gray-900 mt-2">Pre-authorization</h1>
        <p class="text-sm text-gray-500">Patient: <strong><?php echo e($patient->name); ?></strong> (<?php echo e($patient->phone ?? '—'); ?>)</p>
    </div>
    ...
    <form id="preauth-form" class="bg-white rounded-xl border border-gray-200 p-6 space-y-4">
        ...
        <div>
            ...
            <select name="tpa_code" required class="w-full rounded-lg border border-gray-300 px-3 py-2 text-sm">
                <?php if(isset($savedTpaConfigs) && $savedTpaConfigs->count()): ?>
                <optgroup label="Configured for your clinic">
                    <?php $__currentLoopData = $savedTpaConfigs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cfg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($cfg->tpa_code); ?>"><?php echo e($cfg->tpa_name); ?> (<?php echo e($cfg->tpa_code); ?>)</option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </optgroup>
                <?php endif; ?>
                <optgroup label="Common TPAs">
                    <?php $__currentLoopData = $tpas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $code => $info): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($info['code'] ?? $code); ?>"><?php echo e($info['name'] ?? $code); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </optgroup>
            </select>
        </div>
...
(function () {
    ...
    form.addEventListener('submit', async function (e) {
        ...
        try {
            const res = await fetch(<?php echo json_encode(route('insurance.preauth.submit'), 15, 512) ?>, {
                method: 'POST',
                headers: {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/akash/Downloads/clinicos-main/backend/resources/views/insurance/preauth.blade.php ENDPATH**/ ?>