<?php $__env->startSection('title', 'Pharmacist Work Queue'); ?>
...
<div class="p-4 sm:p-6 lg:p-8 space-y-6" x-data="{ dispensingOpen: false, selectedRx: null }">
    ...
    <div class="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        ...
        <div class="flex items-center gap-3 flex-shrink-0">
            <span class="text-xs text-gray-400 font-medium"><?php echo e(now()->format('D, d M Y')); ?></span>
        </div>
    </div>
        ...
        <div class="bg-white rounded-2xl border border-gray-200 shadow-sm p-5 relative overflow-hidden">
            ...
            <div class="flex items-start justify-between pl-3">
                <div>
                    ...
                    <p class="text-3xl font-extrabold text-red-600 leading-none"><?php echo e($pendingCount ?? 0); ?></p>
        ...
        <div class="bg-white rounded-2xl border border-gray-200 shadow-sm p-5 relative overflow-hidden">
            ...
            <div class="flex items-start justify-between pl-3">
                <div>
                    ...
                    <p class="text-3xl font-extrabold text-emerald-600 leading-none"><?php echo e($dispensedToday ?? 0); ?></p>
        ...
        <div class="bg-white rounded-2xl border border-gray-200 shadow-sm p-5 relative overflow-hidden">
            ...
            <div class="flex items-start justify-between pl-3">
                <div>
                    ...
                    <p class="text-3xl font-extrabold text-orange-600 leading-none"><?php echo e($lowStockItems->count()); ?></p>
        ...
        <div class="bg-white rounded-2xl border border-gray-200 shadow-sm p-5 relative overflow-hidden">
            ...
            <div class="flex items-start justify-between pl-3">
                <div>
                    ...
                    <p class="text-3xl font-extrabold text-gray-700 leading-none"><?php echo e($nearExpiryItems->count()); ?></p>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-5 gap-6">
        ...
        <div class="lg:col-span-3 bg-white border border-gray-200 rounded-2xl shadow-sm overflow-hidden">
            <div class="px-6 py-4 border-b border-gray-100 flex items-center justify-between">
                ...
                <a href="<?php echo e(route('pharmacy.history')); ?>" class="text-xs font-semibold text-teal-600 hover:text-teal-700">View History &rarr;</a>
            </div>
            ...
            <div class="overflow-x-auto">
                <table class="w-full">
                    ...
                    <tbody class="divide-y divide-gray-100">
                        <?php $__empty_1 = true; $__currentLoopData = $recentDispensing ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rx): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <?php
                        ...
                        ?>
                        <tr class="hover:bg-teal-50/30 transition-colors group <?php echo e($priority === 'stat' ? 'border-l-4 border-l-red-500' : ''); ?>">
                            <td class="px-5 py-4">
                                <p class="text-sm font-semibold text-gray-900 group-hover:text-teal-700 transition-colors">
                                    <?php echo e($rx->patient->name ?? $rx->patient_name ?? '—'); ?>

                                </p>
                                <p class="text-xs text-gray-400 mt-0.5"><?php echo e($rx->dispensing_number ?? ''); ?></p>
                            </td>
                            <td class="px-5 py-4">
                                <p class="text-sm text-gray-700"><?php echo e($rx->doctor->name ?? $rx->doctor_name ?? '—'); ?></p>
                            </td>
                            <td class="px-5 py-4 text-center">
                                <span class="inline-flex items-center justify-center w-8 h-8 bg-teal-50 text-teal-700 font-bold text-sm rounded-lg ring-1 ring-teal-200">
                                    <?php echo e($rx->items_count ?? $rx->items->count() ?? 0); ?>

                                </span>
                            </td>
                            <td class="px-5 py-4 text-center">
                                <span class="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-semibold <?php echo e($pc['class']); ?>">
                                    <?php echo e($pc['label']); ?>
                            ...
                            <td class="px-5 py-4">
                                <p class="text-xs text-gray-500">
                                    <?php echo e($rx->created_at ? $rx->created_at->format('h:i A') : '—'); ?>

                                </p>
                                <p class="text-xs text-gray-400"><?php echo e($rx->created_at ? $rx->created_at->diffForHumans() : ''); ?></p>
                            </td>
                            <td class="px-5 py-4 text-center">
                                <span class="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-semibold <?php echo e($sc['class']); ?>">
                                    <?php if($rxStatus === 'pending'): ?>
                            ...
                            <td class="px-5 py-4 text-center">
                                <?php if($rxStatus !== 'dispensed'): ?>
                                <a href="<?php echo e(route('pharmacy.dispense.form')); ?>"
        ...
        <div class="lg:col-span-2 space-y-5">
            ...
            <div class="bg-white border border-gray-200 rounded-2xl shadow-sm overflow-hidden">
                <div class="px-5 py-4 border-b border-gray-100 flex items-center justify-between">
                    ...
                    <a href="<?php echo e(route('pharmacy.inventory')); ?>?low_stock=1" class="text-xs font-semibold text-teal-600 hover:text-teal-700">View All &rarr;</a>
                </div>
                <div class="p-4 space-y-2">
                    ...
                    <div class="p-3 rounded-xl bg-gray-50 border border-gray-100">
                        <div class="flex items-center justify-between mb-2">
                            <p class="text-sm font-semibold text-gray-800 truncate"><?php echo e($item->name); ?></p>
                            <span class="text-xs font-bold <?php echo e($stockPercent <= 25 ? 'text-red-600' : 'text-orange-600'); ?>">
                                <?php echo e($item->current_stock ?? 0); ?>/<?php echo e($item->reorder_level ?? 0); ?>

                            </span>
                        </div>
                        <div class="w-full h-2 rounded-full <?php echo e($barBg); ?>">
                            <div class="h-2 rounded-full <?php echo e($barColor); ?> transition-all" style="width: <?php echo e($stockPercent); ?>%"></div>
                        </div>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
            ...
            <div class="bg-white border border-gray-200 rounded-2xl shadow-sm overflow-hidden">
                ...
                <div class="p-4 space-y-2">
                    <?php $__empty_1 = true; $__currentLoopData = $nearExpiryItems->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $expItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <?php
                    ...
                    ?>
                    <div class="flex items-center justify-between p-3 rounded-xl border <?php echo e($urgencyClass); ?>">
                        <div class="min-w-0">
                            <p class="text-sm font-semibold text-gray-800 truncate"><?php echo e($expItem->pharmacyItem->name ?? $expItem->item_name ?? '—'); ?></p>
                            <p class="text-xs text-gray-500 mt-0.5">
                                Batch: <?php echo e($expItem->batch_number ?? '—'); ?> &middot; Qty: <?php echo e($expItem->quantity ?? $expItem->quantity_available ?? 0); ?>

                            </p>
                        </div>
                        <span class="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-bold flex-shrink-0 <?php echo e($badgeClass); ?>">
    ...
    <div class="bg-white border border-gray-200 rounded-2xl shadow-sm overflow-hidden">
        ...
        <div class="p-6">
            <?php if(($recentDispensing ?? collect())->count() > 0): ?>
            <div class="relative">
                <div class="absolute left-4 top-2 bottom-2 w-0.5 bg-gray-200"></div>
                <div class="space-y-5">
                    <?php $__currentLoopData = ($recentDispensing ?? collect())->take(10); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $activity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="flex-1 min-w-0">
                            <div class="flex items-center gap-2 flex-wrap">
                                <p class="text-sm font-semibold text-gray-900">
                                    <?php echo e($activity->patient->name ?? $activity->patient_name ?? 'Unknown'); ?>

                                </p>
                                <span class="text-xs text-gray-400">&middot;</span>
                                <span class="text-xs text-gray-500"><?php echo e($activity->items_count ?? ($activity->items->count() ?? 0)); ?> items</span>
                                <?php if($activity->total ?? null): ?>
                                <span class="text-xs text-gray-400">&middot;</span>
                                <span class="text-xs font-semibold text-gray-700"><?php echo e("\u{20B9}"); ?><?php echo e(number_format($activity->total, 0)); ?></span>
                                <?php endif; ?>
                            </div>
                            <div class="flex items-center gap-2 mt-0.5">
                                <p class="text-xs text-gray-400">
                                    <?php echo e($activity->created_at ? $activity->created_at->format('h:i A') : ''); ?>

                                    &middot; by <?php echo e($activity->dispensedBy->name ?? 'Staff'); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/akash/Downloads/clinicos-main/backend/resources/views/pharmacy/pharmacist-portal.blade.php ENDPATH**/ ?>