...
<div class="w-full max-w-md mx-auto flex flex-col justify-center flex-1 min-h-0">
    <?php echo $__env->make('auth.partials.brand-mark', ['subtitle' => 'Sign in to your clinic workspace'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    ...
    <div class="bg-white rounded-2xl border border-gray-100 shadow-lg shadow-gray-200/40 p-6 sm:p-8">
        ...
        <p class="mt-6 text-center text-sm text-gray-500">
            ...
            <a href="<?php echo e(route('register')); ?>" class="font-semibold text-blue-600 hover:text-blue-700">Create one</a>
        </p>
    </div>
...
<?php echo $__env->make('layouts.guest', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/akash/Downloads/clinicos-main/backend/resources/views/auth/login.blade.php ENDPATH**/ ?>