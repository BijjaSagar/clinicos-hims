...
<?php $__env->startSection('breadcrumb', 'Patient Details'); ?>
        ...
        <div class="flex items-start gap-5">
            ...
            <div class="flex-1">
                <div class="flex items-center gap-3">
                    <h1 class="text-2xl font-bold text-gray-900 font-display"><?php echo e($patient->name); ?></h1>
                    <?php if($patient->abha_number): ?>
                    <span class="px-3 py-1 bg-blue-100 text-blue-700 text-xs font-semibold rounded-full">
                        🛡️ ABHA: <?php echo e($patient->abha_number); ?>
                ...
                <div class="flex flex-wrap items-center gap-4 mt-3 text-sm">
                    <span class="flex items-center gap-1.5 text-gray-600">
                        ...
                        <?php echo e($patient->age ?? 'N/A'); ?> yrs · <?php echo e($patient->gender == 'M' ? 'Male' : ($patient->gender == 'F' ? 'Female' : 'Other')); ?>
                    ...
                    <span class="px-2.5 py-1 bg-red-50 text-red-700 text-xs font-semibold rounded-lg">
                        🩸 <?php echo e($patient->blood_group); ?>
            ...
            <div class="flex gap-2">
                <a href="<?php echo e(route('patients.edit', $patient)); ?>" class="px-4 py-2 text-sm font-semibold text-gray-600 bg-gray-100 hover:bg-gray-200 rounded-xl transition-colors">
                    Edit
                </a>
                <form action="<?php echo e(route('emr.create', $patient)); ?>" method="POST" style="display:inline">
                    <?php echo csrf_field(); ?>
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="bg-white rounded-xl border border-gray-200">
                <div class="px-5 py-4 border-b border-gray-200 flex items-center justify-between">
                    ...
                    <span class="text-sm text-gray-500"><?php echo e($patient->visits->count() ?? 0); ?> total visits</span>
                </div>
                <div class="divide-y divide-gray-200">
                    <?php $__empty_1 = true; $__currentLoopData = $patient->visits()->latest()->take(10)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $visit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <a href="<?php echo e(route('emr.show', ['patient' => $patient->id, 'visit' => $visit->id])); ?>" class="block px-5 py-4 hover:bg-gray-50 transition-colors">
                        <div class="flex items-center justify-between">
                            <div>
                                <p class="font-semibold text-gray-900"><?php echo e($visit->chief_complaint ?? 'General Consultation'); ?></p>
                                <p class="text-sm text-gray-500 mt-0.5"><?php echo e($visit->created_at->format('d M Y, h:i A')); ?></p>
                            </div>
                            <span class="px-2.5 py-1 text-xs font-semibold rounded-full <?php echo e($visit->status === 'completed' ? 'bg-green-100 text-green-700' : 'bg-amber-100 text-amber-700'); ?>">
            ...
            <div class="bg-white rounded-xl border border-gray-200">
                <div class="px-5 py-4 border-b border-gray-200 flex items-center justify-between">
                    ...
                    <a href="<?php echo e(route('billing.create')); ?>?patient_id=<?php echo e($patient->id); ?>" class="text-sm text-blue-600 hover:text-blue-700 font-medium">New Invoice</a>
                </div>
                <div class="divide-y divide-gray-200">
                    <?php $__empty_1 = true; $__currentLoopData = $patient->invoices()->latest()->take(5)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $invoice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="px-5 py-4 flex items-center justify-between hover:bg-gray-50 transition-colors">
                        <div>
                            <p class="font-semibold text-gray-900"><?php echo e($invoice->invoice_number); ?></p>
                            <p class="text-sm text-gray-500"><?php echo e($invoice->created_at->format('d M Y')); ?></p>
                        </div>
                        <div class="text-right">
                            <p class="font-bold text-gray-900">₹<?php echo e(number_format((float) ($invoice->total ?? 0), 2)); ?></p>
                            <?php $payStatus = $invoice->payment_status ?? 'pending'; ?>
                            <span class="px-2 py-0.5 text-xs font-semibold rounded-full <?php echo e($payStatus === 'paid' ? 'bg-green-100 text-green-700' : 'bg-amber-100 text-amber-700'); ?>">
                                <?php echo e(ucfirst($payStatus)); ?>
            ...
            <div class="bg-white rounded-xl border border-gray-200" x-data="{ showUploadModal: <?php echo e($errors->any() ? 'true' : 'false'); ?> }">
                <div class="px-5 py-4 border-b border-gray-200 flex items-center justify-between">
                ...
                <div class="p-5">
                    ...
                    <div class="grid grid-cols-4 gap-3">
                        ...
                        <div class="group relative aspect-square bg-gray-100 rounded-lg overflow-hidden" x-data="{ showDelete: false }">
                            ...
                            <a href="<?php echo e($photoUrl); ?>" target="_blank" class="block w-full h-full">
                                <img src="<?php echo e($photoUrl); ?>" 
                                     alt="<?php echo e($photo->body_region ?? 'Clinical photo'); ?>"
                            ...
                            <div class="absolute top-1 left-1 z-10">
                                <span class="inline-flex px-1.5 py-0.5 rounded text-[9px] font-bold text-white <?php echo e($typeColors[$photo->photo_type] ?? 'bg-gray-500'); ?>">
                                    <?php echo e(strtoupper($photo->photo_type)); ?>
                            ...
                            <div class="absolute inset-x-0 bottom-0 bg-gradient-to-t from-black/70 to-transparent p-2 opacity-0 group-hover:opacity-100 transition-opacity">
                                <span class="text-white text-xs"><?php echo e($photo->body_region ?? 'View'); ?></span>
                            </div>
                            ...
                            <div x-show="showDelete" 
                                ...
                                <div class="bg-white rounded-xl shadow-xl p-6 max-w-sm w-full" @click.stop>
                                    ...
                                    <div class="flex gap-3 mt-6">
                                        ...
                                        <form action="<?php echo e(route('patients.delete-photo', ['patient' => $patient->id, 'photo' => $photo->id])); ?>" 
                    ...
                    <?php if($patient->photos()->count() > 8): ?>
                    <div class="mt-4 text-center">
                        <a href="<?php echo e(route('photo-vault.index')); ?>?patient_id=<?php echo e($patient->id); ?>" class="text-sm text-blue-600 hover:text-blue-700 font-medium">
                            View all <?php echo e($patient->photos()->count()); ?> photos →
                        </a>
                    </div>
                    <?php endif; ?>
                    <?php else: ?>
                ...
                <div x-show="showUploadModal" 
                    ...
                    <div class="bg-white rounded-2xl shadow-xl max-w-xl w-full max-h-[90vh] overflow-y-auto"
                        ...
                        <form action="<?php echo e(route('patients.upload-photo', $patient)); ?>" method="POST" enctype="multipart/form-data" class="p-6 space-y-5">
                            <?php echo csrf_field(); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.photo-consent-signature','data' => ['patientId' => $patient->id,'title' => 'Patient signature (optional)']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['patient-id' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($patient->id),'title' => 'Patient signature (optional)']); ?>
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white rounded-xl border border-gray-200">
                ...
                <div class="p-5 space-y-4 text-sm">
                    <div>
                        ...
                        <p class="text-gray-900"><?php echo e($patient->getAllergiesString() ?: 'None recorded'); ?></p>
                    </div>
                    <div>
                        <p class="text-gray-500 mb-1">Chronic Conditions</p>
                        <p class="text-gray-900"><?php echo e($patient->getConditionsString() ?: 'None recorded'); ?></p>
                    </div>
                    <div>
                        <p class="text-gray-500 mb-1">Current Medications</p>
                        <p class="text-gray-900"><?php echo e($patient->getCurrentMedicationsString() ?: 'None recorded'); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl border border-gray-200">
                ...
                <div class="p-5 text-sm">
                    ...
                    <p class="font-semibold text-gray-900"><?php echo e($patient->emergency_contact_name); ?></p>
                    <p class="text-gray-500"><?php echo e($patient->emergency_contact_relation); ?></p>
                    <p class="text-gray-600 mt-1"><?php echo e($patient->emergency_contact_phone); ?></p>
                    <?php else: ?>
            ...
            <div class="bg-white rounded-xl border border-gray-200 p-5">
                ...
                <div class="space-y-2">
                    ...
                    <a href="<?php echo e(route('appointments.create')); ?>?patient_id=<?php echo e($patient->id); ?>" class="w-full flex items-center gap-3 px-4 py-3 text-sm font-medium text-gray-700 bg-gray-50 hover:bg-gray-100 rounded-xl transition-colors">
                        <svg class="w-5 h-5 text-blue-600" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/>
                        </svg>
                        Book Appointment
                    </a>
                    <a href="<?php echo e(route('billing.create')); ?>?patient_id=<?php echo e($patient->id); ?>" class="w-full flex items-center gap-3 px-4 py-3 text-sm font-medium text-gray-700 bg-gray-50 hover:bg-gray-100 rounded-xl transition-colors">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/akash/Downloads/clinicos-main/backend/resources/views/patients/show.blade.php ENDPATH**/ ?>