...
function gastroenterologyEMR() {
    return {
        ...
        formData: <?php echo json_encode(($visit ?? null)?->getStructuredField('gastroenterology_data') ?? $gastroenterologyFormDataDefault, 15, 512) ?>,
        commonDiagnoses: [
        ...
        selectedDiagnoses: <?php echo json_encode(($visit ?? null)?->getStructuredField('gastroenterology_diagnoses') ?? [], 15, 512) ?>,
...
<?php /**PATH /Users/akash/Downloads/clinicos-main/backend/resources/views/emr/specialty/gastroenterology.blade.php ENDPATH**/ ?>