...
<?php $__env->startSection('subtitle', 'Manage all users across the platform'); ?>

<?php $__env->startSection('header_actions'); ?>
<a href="<?php echo e(route('admin.users.create')); ?>" class="inline-flex items-center gap-2 px-4 py-2.5 bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-semibold rounded-xl transition-colors">
...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-5 gap-4">
        ...
        <div class="bg-white rounded-xl p-4 border border-gray-100">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <p class="text-2xl font-bold text-gray-900"><?php echo e($stats['super_admins']); ?></p>
        ...
        <div class="bg-white rounded-xl p-4 border border-gray-100">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <p class="text-2xl font-bold text-gray-900"><?php echo e($stats['owners']); ?></p>
        ...
        <div class="bg-white rounded-xl p-4 border border-gray-100">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <p class="text-2xl font-bold text-gray-900"><?php echo e($stats['doctors']); ?></p>
        ...
        <div class="bg-white rounded-xl p-4 border border-gray-100">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <p class="text-2xl font-bold text-gray-900"><?php echo e($stats['staff']); ?></p>
    ...
    <div class="bg-white rounded-xl p-4 border border-gray-100">
        <form action="<?php echo e(route('admin.users.index')); ?>" method="GET" class="flex items-center gap-4">
            <div class="flex-1">
            ...
            <select name="clinic_id" class="px-4 py-2.5 rounded-lg border border-gray-300 focus:ring-2 focus:ring-indigo-500">
                ...
                <option value="<?php echo e($clinic->id); ?>" <?php echo e(request('clinic_id') == $clinic->id ? 'selected' : ''); ?>><?php echo e($clinic->name); ?></option>
            ...
            <?php if(request()->hasAny(['search', 'role', 'clinic_id', 'status'])): ?>
            <a href="<?php echo e(route('admin.users.index')); ?>" class="px-4 py-2.5 text-gray-500 hover:text-gray-700">Clear</a>
            <?php endif; ?>
        </form>
    </div>
                ...
                <tr class="hover:bg-gray-50">
                    <td class="px-6 py-4">
                        <div class="flex items-center gap-3">
                            <div class="w-10 h-10 rounded-full flex items-center justify-center
                                <?php if($user->role === 'super_admin'): ?> bg-indigo-100 text-indigo-600
                                <?php elseif($user->role === 'owner'): ?> bg-purple-100 text-purple-600
                                <?php elseif($user->role === 'doctor'): ?> bg-green-100 text-green-600
                                <?php else: ?> bg-gray-100 text-gray-600 <?php endif; ?>
                            ">
                                <span class="font-semibold"><?php echo e(substr($user->name, 0, 1)); ?></span>
                            </div>
                            <div>
                    ...
                    <td class="px-6 py-4">
                        <span class="inline-flex px-2 py-1 text-xs font-medium rounded-full
                            <?php if($user->role === 'super_admin'): ?> bg-indigo-100 text-indigo-700
                            <?php elseif($user->role === 'owner'): ?> bg-purple-100 text-purple-700
                            <?php elseif($user->role === 'doctor'): ?> bg-green-100 text-green-700
                            <?php else: ?> bg-gray-100 text-gray-700 <?php endif; ?>
                        "><?php echo e(ucfirst(str_replace('_', ' ', $user->role))); ?></span>
                    </td>
                    <td class="px-6 py-4">
                        <?php if($user->clinic): ?>
                        <a href="<?php echo e(route('admin.clinics.show', $user->clinic)); ?>" class="text-sm text-indigo-600 hover:text-indigo-700">
                            <?php echo e($user->clinic->name); ?>
                    ...
                    <td class="px-6 py-4 text-right">
                        <div class="flex items-center justify-end gap-1" x-data="{ showDeleteModal: false }">
                            ...
                            <a href="<?php echo e(route('admin.users.edit', $user)); ?>" class="p-2 text-gray-500 hover:text-blue-600 hover:bg-blue-50 rounded-lg transition-colors" title="Edit">
                            ...
                            <form action="<?php echo e(route('admin.users.toggle-status', $user)); ?>" method="POST" class="inline">
                                <?php echo csrf_field(); ?>
                                <button type="submit" class="p-2 text-gray-500 hover:text-amber-600 hover:bg-amber-50 rounded-lg transition-colors" title="<?php echo e($user->is_active ? 'Deactivate' : 'Activate'); ?>">
                                    <?php if($user->is_active): ?>
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24">
                            ...
                            <div x-show="showDeleteModal" x-cloak class="fixed inset-0 z-50 flex items-center justify-center" @keydown.escape.window="showDeleteModal = false">
                                ...
                                <div class="relative bg-white rounded-2xl shadow-xl p-6 max-w-md mx-4" @click.stop>
                                    <div class="text-center">
                                        ...
                                        <p class="text-sm text-gray-500 mb-6">Are you sure you want to delete <strong><?php echo e($user->name); ?></strong>? This action cannot be undone.</p>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/akash/Downloads/clinicos-main/backend/resources/views/admin/users/index.blade.php ENDPATH**/ ?>