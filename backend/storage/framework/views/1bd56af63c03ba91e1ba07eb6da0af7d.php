    ...
    <div class="mt-2 space-y-2 text-sm opacity-[0.98] pl-0 sm:pl-7">
        <?php if($context === 'dispense'): ?>
            ...
            <p>
                ...
                <a href="<?php echo e(url('/pharmacy/inventory?add_medicine=1')); ?>" class="font-semibold underline decoration-blue-400 hover:text-blue-950">Pharmacy, then Inventory, then Add Medicine</a>.
        ...
        <?php else: ?>
            ...
            <p>
                ...
                <a href="<?php echo e(url('/pharmacy/purchases/create')); ?>" class="font-semibold underline decoration-blue-400 hover:text-blue-950">Record GRN</a>.
                Staff can <strong>update quantities later</strong>; you do not need perfect stock on day one.
            </p>
        <?php endif; ?>
    </div>
</div>
<?php /**PATH /Users/akash/Downloads/clinicos-main/backend/resources/views/pharmacy/partials/catalog-stock-hint.blade.php ENDPATH**/ ?>