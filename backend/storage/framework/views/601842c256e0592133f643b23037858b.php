...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="space-y-6">
            <form method="POST" action="<?php echo e(route('hospital-settings.update')); ?>" class="space-y-6">
                <?php echo csrf_field(); ?>
                ...
                <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="text" name="hospital_name" value="<?php echo e(old('hospital_name', $settings['hospital_name'])); ?>" required
                        ...
                        <div>
                            ...
                            <select name="hospital_type"
                                ...
                                <option value="clinic"        <?php echo e($settings['hospital_type'] === 'clinic'        ? 'selected' : ''); ?>>Clinic</option>
                                <option value="hospital"      <?php echo e($settings['hospital_type'] === 'hospital'      ? 'selected' : ''); ?>>Hospital</option>
                                <option value="nursing_home"  <?php echo e($settings['hospital_type'] === 'nursing_home'  ? 'selected' : ''); ?>>Nursing Home</option>
                                <option value="polyclinic"    <?php echo e($settings['hospital_type'] === 'polyclinic'    ? 'selected' : ''); ?>>Polyclinic</option>
                            </select>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Registration Prefix</label>
                            <input type="text" name="registration_prefix" value="<?php echo e(old('registration_prefix', $settings['registration_prefix'])); ?>"
                ...
                <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
                    ...
                    <div class="grid grid-cols-3 gap-4">
                        <div>
                            ...
                            <input type="number" name="total_beds" value="<?php echo e(old('total_beds', $settings['total_beds'])); ?>" min="0" placeholder="0"
                                class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-brand-blue/30 focus:border-brand-blue transition-colors">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">ICU Beds</label>
                            <input type="number" name="icu_beds" value="<?php echo e(old('icu_beds', $settings['icu_beds'])); ?>" min="0" placeholder="0"
                                class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-brand-blue/30 focus:border-brand-blue transition-colors">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Emergency Beds</label>
                            <input type="number" name="emergency_beds" value="<?php echo e(old('emergency_beds', $settings['emergency_beds'])); ?>" min="0" placeholder="0"
                                class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-brand-blue/30 focus:border-brand-blue transition-colors">
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
                    ...
                    <div class="space-y-3">
                        ...
                        <label class="flex items-start gap-3 cursor-pointer p-3 rounded-lg border border-gray-200 hover:bg-gray-50 transition-colors">
                            <input type="checkbox" name="<?php echo e($module['key']); ?>" value="1"
                                <?php echo e($settings[$module['key']] === '1' ? 'checked' : ''); ?>

                                class="mt-0.5 w-4 h-4 text-brand-blue border-gray-300 rounded focus:ring-brand-blue/30">
                            <div>
                                <p class="text-sm font-medium text-gray-800"><?php echo e($module['label']); ?></p>
                                <p class="text-xs text-gray-500"><?php echo e($module['desc']); ?></p>
                            </div>
                        </label>
                ...
                <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
                    ...
                    <textarea name="discharge_summary_footer" rows="4"
                        ...
                        class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-brand-blue/30 focus:border-brand-blue transition-colors resize-none"><?php echo e(old('discharge_summary_footer', $settings['discharge_summary_footer'])); ?></textarea>
                </div>
        ...
        <div x-data="{
            ...
            <div class="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
                <div class="flex items-center justify-between px-6 py-4 border-b border-gray-100">
                    <div>
                        ...
                        <p class="text-xs text-gray-500 mt-0.5"><?php echo e($wards->count()); ?> ward(s) configured</p>
                    </div>
                    ...
                    <div class="flex items-start justify-between gap-4 px-6 py-4 hover:bg-gray-50 transition-colors">
                        <div class="flex-1 min-w-0">
                            <div class="flex items-center gap-2">
                                <p class="font-medium text-gray-900 truncate"><?php echo e($ward->name); ?></p>
                                <span class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium
                                    <?php echo e(data_get($ward, 'is_active', true) ? 'bg-emerald-50 text-emerald-700' : 'bg-gray-100 text-gray-500'); ?>">
                                    <?php echo e(data_get($ward, 'is_active', true) ? 'Active' : 'Inactive'); ?>

                                </span>
                            </div>
                            <div class="flex items-center gap-3 mt-1 text-xs text-gray-500">
                                <span class="capitalize"><?php echo e(str_replace('_', ' ', data_get($ward, 'type', data_get($ward, 'ward_type', data_get($ward, 'is_icu') ? 'icu' : 'general')))); ?></span>
                                <span>·</span>
                                <span><?php echo e((int) ($wardBedCounts[$ward->id] ?? data_get($ward, 'total_beds', 0))); ?> beds</span>
                                <?php if($ward->floor): ?>
                                    <span>·</span>
                                    <span>Floor: <?php echo e($ward->floor); ?></span>
                                <?php endif; ?>
                            </div>
                            <?php
                                $wardRooms = $roomsByWard[$ward->id] ?? collect();
                            ?>
                            <?php if($wardRooms->isNotEmpty()): ?>
                            <div class="mt-2 text-xs text-gray-600">
                                <span class="font-medium text-gray-700">Rooms:</span>
                                <?php $__currentLoopData = $wardRooms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <span class="inline-flex items-center px-2 py-0.5 rounded bg-gray-100 text-gray-800 mr-1 mb-1"><?php echo e($r->name); ?></span>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
                            <?php endif; ?>
                            <form method="POST" action="<?php echo e(route('hospital-settings.ward.rooms.store')); ?>" class="mt-3 flex flex-wrap items-end gap-2 border-t border-gray-50 pt-3">
                                <?php echo csrf_field(); ?>
                                <input type="hidden" name="ward_id" value="<?php echo e($ward->id); ?>">
                                <div>
                            ...
                            <?php if($wardRooms->isNotEmpty()): ?>
                                <div class="mt-3 space-y-2">
                                    ...
                                    <?php $__currentLoopData = $wardRooms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $room): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="flex flex-wrap items-center gap-x-3 gap-y-2 rounded-lg bg-gray-50/80 px-3 py-2 border border-gray-100">
                                            <div class="min-w-0 flex-1">
                                                <span class="text-sm font-medium text-gray-900"><?php echo e($room->name); ?></span>
                                                <span class="text-xs text-gray-500 ml-2"><?php echo e((int) ($roomBedCounts[$room->id] ?? 0)); ?> bed(s)</span>
                                            </div>
                                            <form method="POST" action="<?php echo e(route('hospital-settings.ward.room.beds')); ?>" class="flex flex-wrap items-end gap-2">
                                                <?php echo csrf_field(); ?>
                                                <input type="hidden" name="room_id" value="<?php echo e($room->id); ?>">
                                                <label class="sr-only">Bed count for <?php echo e($room->name); ?></label>
                            ...
                            <?php else: ?>
                                <form method="POST" action="<?php echo e(route('hospital-settings.ward.beds')); ?>" class="mt-3 flex flex-wrap items-end gap-2">
                                    <?php echo csrf_field(); ?>
                                    <input type="hidden" name="ward_id" value="<?php echo e($ward->id); ?>">
                                    <div>
                        ...
                        <div class="flex flex-col gap-2 flex-shrink-0 pt-0.5">
                            <button type="button"
                                @click='openEdit(<?php echo json_encode($wardEditPayload, 15, 512) ?>)'
                            ...
                            <form method="POST" action="<?php echo e(route('hospital-settings.ward.destroy', $ward->id)); ?>"
                                onsubmit="return confirm('Delete ward &quot;<?php echo e($ward->name); ?>&quot;? Rooms and beds under it will be removed. This cannot be undone if there are no active admissions.');">
                                <?php echo csrf_field(); ?>
            ...
            <div x-show="wardOpen" x-cloak class="fixed inset-0 z-50 flex items-center justify-center p-4" @keydown.escape.window="wardOpen = false">
                ...
                <div class="relative bg-white rounded-2xl shadow-2xl w-full max-w-lg max-h-[90vh] overflow-y-auto" @click.stop>
                    ...
                    <form method="POST" action="<?php echo e(route('hospital-settings.ward.store')); ?>" class="p-6 space-y-4">
                        <?php echo csrf_field(); ?>
                        <div>
            ...
            <div x-show="editOpen" x-cloak class="fixed inset-0 z-50 flex items-center justify-center p-4" @keydown.escape.window="closeEdit()">
                ...
                <div class="relative bg-white rounded-2xl shadow-2xl w-full max-w-lg max-h-[90vh] overflow-y-auto" @click.stop>
                    ...
                    <form method="POST" x-bind:action="'<?php echo e(url('/hospital-settings/wards')); ?>/' + (edit.id || '')" class="p-6 space-y-4">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/akash/Downloads/clinicos-main/backend/resources/views/hospital-settings/index.blade.php ENDPATH**/ ?>