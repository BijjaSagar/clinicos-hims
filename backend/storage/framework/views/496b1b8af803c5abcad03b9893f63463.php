...
function pulmonologyEMR() {
    return {
        ...
        formData: <?php echo json_encode(($visit ?? null)?->getStructuredField('pulmonology_data') ?? $pulmonologyFormDataDefault, 15, 512) ?>,
        commonDiagnoses: [
        ...
        selectedDiagnoses: <?php echo json_encode(($visit ?? null)?->getStructuredField('pulmonology_diagnoses') ?? [], 15, 512) ?>,
        get packYears() {
...
<?php /**PATH /Users/akash/Downloads/clinicos-main/backend/resources/views/emr/specialty/pulmonology.blade.php ENDPATH**/ ?>