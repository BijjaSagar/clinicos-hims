...
function generalPhysicianEMR() {
    return {
        ...
        formData: <?php echo json_encode(($visit ?? null)?->getStructuredField('general_physician_data') ?? $generalPhysicianFormDataDefault, 15, 512) ?>,
        commonDiagnoses: [
        ...
        selectedDiagnoses: <?php echo json_encode(($visit ?? null)?->getStructuredField('general_physician_diagnoses') ?? [], 15, 512) ?>,
        init() {
...
<?php /**PATH /Users/akash/Downloads/clinicos-main/backend/resources/views/emr/specialty/general_physician.blade.php ENDPATH**/ ?>