...
function rheumatologyEMR() {
    return {
        ...
        formData: <?php echo json_encode(($visit ?? null)?->getStructuredField('rheumatology_data') ?? $rheumatologyFormDataDefault, 15, 512) ?>,
        commonDiagnoses: [
        ...
        selectedDiagnoses: <?php echo json_encode(($visit ?? null)?->getStructuredField('rheumatology_diagnoses') ?? [], 15, 512) ?>,
        get das28Display() {
...
<?php /**PATH /Users/akash/Downloads/clinicos-main/backend/resources/views/emr/specialty/rheumatology.blade.php ENDPATH**/ ?>