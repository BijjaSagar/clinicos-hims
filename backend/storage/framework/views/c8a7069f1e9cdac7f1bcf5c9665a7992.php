...
function orthopaedicsEMR() {
    return {
        ...
        selectedJoints: <?php echo json_encode($visit->getStructuredField('ortho.joints') ?? [], 15, 512) ?>,
        
        examData: <?php echo json_encode($visit->getStructuredField('ortho.exam') ?? $orthoExamDefault, 15, 512) ?>,
        
        painData: <?php echo json_encode($visit->getStructuredField('ortho.pain') ?? $orthoPainDefault, 15, 512) ?>,
        
        romData: <?php echo json_encode($visit->getStructuredField('ortho.rom') ?? $orthoRomDefault, 15, 512) ?>,
        ...
        powerData: <?php echo json_encode($visit->getStructuredField('ortho.power') ?? $orthoPowerDefault, 15, 512) ?>,
        ...
        specialTests: <?php echo json_encode($visit->getStructuredField('ortho.specialTests') ?? new \stdClass(), 15, 512) ?>,
        
        fractureData: <?php echo json_encode($visit->getStructuredField('ortho.fracture') ?? $orthoFractureDefault, 15, 512) ?>,
        ...
        treatmentPlan: <?php echo json_encode($visit->getStructuredField('ortho.treatment') ?? $orthoTreatmentDefault, 15, 512) ?>,
...
<?php /**PATH /Users/akash/Downloads/clinicos-main/backend/resources/views/emr/specialty/orthopaedics.blade.php ENDPATH**/ ?>