<?php $__env->startSection('title', 'ABDM'); ?>
<?php $__env->startSection('breadcrumb', 'Ayushman Bharat Digital Mission'); ?>
...
<div class="p-6 space-y-6" x-data="abdmData()">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="bg-white rounded-xl border border-gray-200">
            ...
            <div class="p-5">
                <div class="text-center py-4">
                    <div class="text-4xl font-extrabold text-blue-600 font-display"><?php echo e($stats['abha_created'] ?? 156); ?></div>
                    <p class="text-gray-500 mt-1">Total ABHA IDs Created</p>
                </div>
                <div class="space-y-3 mt-4">
                    <div class="flex justify-between text-sm">
                        <span class="text-gray-500">This Month</span>
                        <span class="font-semibold text-gray-900"><?php echo e($stats['abha_this_month'] ?? 23); ?></span>
                    </div>
                    <div class="flex justify-between text-sm">
                        <span class="text-gray-500">Linked Patients</span>
                        <span class="font-semibold text-green-600"><?php echo e($stats['abha_linked'] ?? 142); ?></span>
                    </div>
                </div>
        ...
        <div class="bg-white rounded-xl border border-gray-200">
            ...
            <div class="p-5">
                <div class="text-center py-4">
                    <div class="text-4xl font-extrabold text-green-600 font-display"><?php echo e($stats['records_shared'] ?? 892); ?></div>
                    <p class="text-gray-500 mt-1">Records Shared</p>
                </div>
                <div class="space-y-3 mt-4">
                    <div class="flex justify-between text-sm">
                        <span class="text-gray-500">Prescriptions</span>
                        <span class="font-semibold text-gray-900"><?php echo e($stats['prescriptions'] ?? 456); ?></span>
                    </div>
                    <div class="flex justify-between text-sm">
                        <span class="text-gray-500">Diagnostic Reports</span>
                        <span class="font-semibold text-gray-900"><?php echo e($stats['diagnostics'] ?? 234); ?></span>
                    </div>
                    <div class="flex justify-between text-sm">
                        <span class="text-gray-500">Discharge Summaries</span>
                        <span class="font-semibold text-gray-900"><?php echo e($stats['discharge'] ?? 89); ?></span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl border border-gray-200">
            ...
            <div class="p-5">
                <div class="text-center py-4">
                    <div class="text-4xl font-extrabold text-purple-600 font-display"><?php echo e($stats['consents'] ?? 67); ?></div>
                    <p class="text-gray-500 mt-1">Active Consents</p>
                </div>
                <div class="space-y-3 mt-4">
                    <div class="flex justify-between text-sm">
                        <span class="text-gray-500">Pending Requests</span>
                        <span class="font-semibold text-amber-600"><?php echo e($stats['pending_consents'] ?? 5); ?></span>
                    </div>
                    <div class="flex justify-between text-sm">
                        <span class="text-gray-500">Expired</span>
                        <span class="font-semibold text-gray-500"><?php echo e($stats['expired_consents'] ?? 12); ?></span>
                    </div>
                </div>
        ...
        <div class="p-5">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div>
                    ...
                    <p class="font-semibold text-gray-900"><?php echo e(auth()->user()->clinic->hfr_facility_id ?? 'IN0410000123'); ?></p>
                </div>
                <div>
                    <p class="text-sm text-gray-500">HFR ID</p>
                    <p class="font-semibold text-gray-900"><?php echo e(auth()->user()->clinic->hfr_id ?? 'HFR-MH-12345'); ?></p>
                </div>
                <div>
                ...
                <div>
                    ...
                    <p class="font-semibold text-gray-900"><?php echo e(now()->subHours(2)->format('d M Y, h:i A')); ?></p>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <select x-model="linkPatientId" class="w-full px-4 py-3 rounded-xl border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                        ...
                        <?php $__currentLoopData = \App\Models\Patient::where('clinic_id', auth()->user()->clinic_id)->whereNull('abha_id')->orderBy('name')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $patient): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
document.addEventListener('alpine:init', () => {
    Alpine.data('abdmData', () => ({
        ...
        async generateOtp() {
            ...
            try {
                const endpoint = this.verificationMethod === 'aadhaar' 
                    ? '<?php echo e(route('abdm.aadhaar.otp')); ?>'
                    : '<?php echo e(route('abdm.mobile.otp')); ?>';
        ...
        async verifyOtp() {
            ...
            try {
                const endpoint = this.verificationMethod === 'aadhaar'
                    ? '<?php echo e(route('abdm.aadhaar.verify')); ?>'
                    : '<?php echo e(route('abdm.mobile.verify')); ?>';
        ...
        async linkAbha() {
            ...
            try {
                const response = await fetch('<?php echo e(route('abdm.link')); ?>', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                        'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>',
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/akash/Downloads/clinicos-main/backend/resources/views/abdm/index.blade.php ENDPATH**/ ?>