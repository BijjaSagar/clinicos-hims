...
function gynaecologyEMR() {
    return {
        mode: <?php echo json_encode($visit->getStructuredField('gynae.mode') ?? 'gynae', 15, 512) ?>,
        ...
        menstrualData: <?php echo json_encode($visit->getStructuredField('gynae.menstrual') ?? $gynaeMenstrualDefault, 15, 512) ?>,
        
        obsHistory: <?php echo json_encode($visit->getStructuredField('gynae.obsHistory') ?? $gynaeObsHistoryDefault, 15, 512) ?>,
        
        pvExam: <?php echo json_encode($visit->getStructuredField('gynae.pv') ?? $gynaePvDefault, 15, 512) ?>,
        
        screening: <?php echo json_encode($visit->getStructuredField('gynae.screening') ?? $gynaeScreeningDefault, 15, 512) ?>,
        ...
        pregnancy: <?php echo json_encode($visit->getStructuredField('obs.pregnancy') ?? $obsPregnancyDefault, 15, 512) ?>,
        
        ancExam: <?php echo json_encode($visit->getStructuredField('obs.anc') ?? $obsAncDefault, 15, 512) ?>,
        
        investigations: <?php echo json_encode($visit->getStructuredField('obs.investigations') ?? $obsInvestigationsDefault, 15, 512) ?>,
        
        usg: <?php echo json_encode($visit->getStructuredField('obs.usg') ?? $obsUsgDefault, 15, 512) ?>,
        ...
        selectedDiagnoses: <?php echo json_encode($visit->getStructuredField('gynae.diagnoses') ?? [], 15, 512) ?>,
...
<?php /**PATH /Users/akash/Downloads/clinicos-main/backend/resources/views/emr/specialty/gynaecology.blade.php ENDPATH**/ ?>