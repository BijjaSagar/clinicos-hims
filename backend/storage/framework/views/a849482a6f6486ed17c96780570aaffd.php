<?php $__env->startSection('title', 'ABDM Health Information Provider'); ?>

<?php $__env->startSection('breadcrumb', 'ABDM / HIP'); ?>
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
        <div class="bg-white rounded-xl border border-gray-200 p-6">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <div class="text-2xl font-bold text-gray-900"><?php echo e($stats['linked_patients']); ?></div>
        ...
        <div class="bg-white rounded-xl border border-gray-200 p-6">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <div class="text-2xl font-bold text-gray-900"><?php echo e($stats['records_shared']); ?></div>
        ...
        <div class="bg-white rounded-xl border border-gray-200 p-6">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <div class="text-2xl font-bold text-gray-900"><?php echo e($stats['pending_consents']); ?></div>
        ...
        <div class="bg-white rounded-xl border border-gray-200 p-6">
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <div class="font-mono text-sm text-gray-900"><?php echo e($clinic?->hfr_id ?? 'Not Registered'); ?></div>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="p-6">
                <div class="space-y-4">
                    ...
                    <div class="flex items-start gap-4">
                        <div class="w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold <?php echo e($clinic?->hfr_id ? 'bg-green-500 text-white' : 'bg-gray-200 text-gray-600'); ?>">
                            <?php echo e($clinic?->hfr_id ? '✓' : '1'); ?>
                        ...
                        <div class="flex-1">
                            ...
                            <?php if(!$clinic?->hfr_id): ?>
                            <a href="<?php echo e(route('abdm.index')); ?>" class="inline-flex items-center mt-2 text-sm text-orange-600 hover:text-orange-700">
                                Go to ABDM Centre →
                            </a>
                            <?php endif; ?>
                        </div>
                    ...
                    <div class="flex items-start gap-4">
                        <div class="w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold <?php echo e($stats['hip_registered'] ? 'bg-green-500 text-white' : 'bg-gray-200 text-gray-600'); ?>">
                            <?php echo e($stats['hip_registered'] ? '✓' : '2'); ?>
                        ...
                        <div class="flex-1">
                            ...
                            <?php if($clinic?->hfr_id && !$stats['hip_registered']): ?>
                    ...
                    <div class="flex items-start gap-4">
                        <div class="w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold <?php echo e($stats['linked_patients'] > 0 ? 'bg-green-500 text-white' : 'bg-gray-200 text-gray-600'); ?>">
                            <?php echo e($stats['linked_patients'] > 0 ? '✓' : '3'); ?>
                            ...
                            <select x-model="linkForm.patient_id" class="w-full px-4 py-2 border border-gray-200 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent">
                                ...
                                <?php
                                    $abhaPatients = \App\Models\Patient::where('clinic_id', auth()->user()->clinic_id)
                                        ...
                                        ->get(['id', 'name', 'abha_id']);
                                ?>
                                <?php $__currentLoopData = $abhaPatients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $patient): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($patient->id); ?>"><?php echo e($patient->name); ?> (<?php echo e($patient->abha_id); ?>)</option>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/akash/Downloads/clinicos-main/backend/resources/views/abdm/hip.blade.php ENDPATH**/ ?>