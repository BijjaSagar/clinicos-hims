...
<head>
    ...
    <title>Admission Card – <?php echo e($admission->patient->full_name); ?></title>
...
<body class="bg-gray-100 p-6" x-data="cardPrinter()" x-init="init()">
    ...
    <div class="no-print max-w-2xl mx-auto mb-6 bg-white rounded-xl shadow p-5">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-sm text-gray-500"><?php echo e($admission->patient->full_name); ?> &mdash; <?php echo e($admission->admission_number ?? 'IPD-'.$admission->id); ?></p>
            </div>
        ...
        <div class="mt-4 flex items-center gap-4">
            ...
            <div class="flex gap-2">
                ...
                <button
                    onclick="setCopies(<?php echo e($n); ?>)"
                    :id="'btn-<?php echo e($n); ?>'"
                    class="w-9 h-9 rounded-lg border-2 font-bold text-sm transition-all"
                    :class="copies === <?php echo e($n); ?> ? 'border-blue-600 bg-blue-600 text-white' : 'border-gray-300 text-gray-700 hover:border-blue-400'"
                    x-data
                    @click="$dispatch('set-copies', { n: <?php echo e($n); ?> })"
                ><?php echo e($n); ?></button>
    ...
    <div id="cards-container" class="max-w-2xl mx-auto flex flex-wrap gap-4 justify-center">
        ...
        <div class="card-wrapper" id="card-template">
            <div class="card">
                <div class="hosp-name"><?php echo e(strtoupper($clinicName)); ?></div>
                <div class="patient-name"><?php echo e($admission->patient->full_name); ?></div>
                <div class="info-row">
                    <span class="info-label">Age/Sex</span>
                    <span><?php echo e($patientAge); ?> / <?php echo e(ucfirst($admission->patient->gender ?? 'N/A')); ?></span>
                    <span class="ml-auto"><span class="badge"><?php echo e($admissionNo); ?></span></span>
                </div>
                <hr class="divider">
                <div class="info-row"><span class="info-label">Ward/Bed</span><span><?php echo e($wardBed); ?></span></div>
                <div class="info-row"><span class="info-label">Doctor</span><span>Dr. <?php echo e($doctor); ?></span></div>
                <div class="info-row"><span class="info-label">Admitted</span><span><?php echo e($admittedDate); ?></span></div>
                <div class="info-row"><span class="info-label">Diagnosis</span><span class="truncate max-w-xs"><?php echo e($admission->admission_diagnosis ?? 'Under evaluation'); ?></span></div>
                <?php if($emergency): ?>
                <hr class="divider">
                <div class="info-row"><span class="info-label">Emergency</span><span><?php echo e($emergency); ?><?php echo e($emergencyPhone ? ' · '.$emergencyPhone : ''); ?></span></div>
                <?php endif; ?>
...
<?php /**PATH /Users/akash/Downloads/clinicos-main/backend/resources/views/ipd/visiting-card.blade.php ENDPATH**/ ?>