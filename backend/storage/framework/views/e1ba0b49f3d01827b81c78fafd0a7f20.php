...
function homeopathyEMR() {
    return {
        ...
        formData: <?php echo json_encode(($visit ?? null)?->getStructuredField('homeopathy_data') ?? $homeopathyFormDataDefault, 15, 512) ?>,
        commonDiagnoses: [
        ...
        selectedDiagnoses: <?php echo json_encode(($visit ?? null)?->getStructuredField('homeopathy_diagnoses') ?? [], 15, 512) ?>,
...
<?php /**PATH /Users/akash/Downloads/clinicos-main/backend/resources/views/emr/specialty/homeopathy.blade.php ENDPATH**/ ?>