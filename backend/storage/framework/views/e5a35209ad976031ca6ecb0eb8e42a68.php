...
<div
    ...
    x-data="photoConsentSignature(<?php echo e($pid); ?>)"
    x-init="initCanvas()"
>
    <div class="flex flex-wrap items-start justify-between gap-2 mb-3">
        <div>
            <h4 class="text-sm font-semibold text-gray-900"><?php echo e($title); ?></h4>
...
<?php if (! $__env->hasRenderedOnce('54b832ee-ba9c-4158-8cc6-f983fed726d3')): $__env->markAsRenderedOnce('54b832ee-ba9c-4158-8cc6-f983fed726d3'); ?>
        ...
        function photoConsentSignature(patientId) {
            return {
                ...
                async saveConsent() {
                    ...
                    const url = <?php echo json_encode(route('photo-vault.consent'), 15, 512) ?>;
    ...
    <?php $__env->stopPush(); ?>
<?php endif; ?>
<?php /**PATH /Users/akash/Downloads/clinicos-main/backend/resources/views/components/photo-consent-signature.blade.php ENDPATH**/ ?>