...
<body class="antialiased">
    <div x-data="bookingApp()" class="min-h-screen py-4 sm:py-8 px-3 sm:px-4 pb-8">
        ...
        <div class="max-w-2xl mx-auto mb-4 text-center">
            <a href="<?php echo e(route('public.booking.directory')); ?>" class="text-sm text-blue-600 hover:text-blue-800 font-medium">← All clinics</a>
        </div>
        <div class="max-w-2xl mx-auto mb-8 text-center">
            <?php if($clinic->logo_url): ?>
                <img src="<?php echo e($clinic->logo_url); ?>" alt="<?php echo e($clinic->name); ?>" class="w-20 h-20 mx-auto rounded-full mb-4 object-cover shadow-lg">
            <?php else: ?>
            ...
            <?php endif; ?>
            <h1 class="sora text-2xl font-bold text-gray-900"><?php echo e($clinic->name); ?></h1>
            <p class="text-gray-500 mt-1">Book Your Appointment Online</p>
            <?php if($clinic->phone): ?>
                <p class="text-sm text-gray-400 mt-1">📞 <?php echo e($clinic->phone); ?></p>
            <?php endif; ?>
        </div>
                    ...
                    <label class="block">
                        ...
                        <select x-model="form.doctor_id" @change="form.service_id = ''" class="w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-shadow">
                            ...
                            <?php $__currentLoopData = $doctors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $doctor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($doctor->id); ?>">Dr. <?php echo e($doctor->name); ?> <?php echo e($doctor->specialty ? '— ' . ucfirst($doctor->specialty) : ''); ?></option>
                    ...
                    <label class="block">
                        ...
                        <select x-model="form.service_id" class="w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-shadow">
                            ...
                            <?php $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($service->id); ?>"><?php echo e($service->name); ?> (<?php echo e($service->duration_mins); ?> mins) <?php echo e($service->advance_amount ? '— ₹' . $service->advance_amount . ' advance' : ''); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </label>
                    <?php endif; ?>
    ...
    <script>
        console.log('Public booking page loaded for clinic: <?php echo e($clinic->slug); ?>');
        ...
        function bookingApp() {
            return {
                ...
                doctors: <?php echo json_encode($doctors, 15, 512) ?>,
                services: <?php echo json_encode($services, 15, 512) ?>,
                clinicSlug: '<?php echo e($clinic->slug); ?>',
                clinicName: '<?php echo e($clinic->name); ?>',
                requireAdvance: <?php echo e($bookingSettings['require_advance'] ? 'true' : 'false'); ?>,
                clinicMinAdvance: <?php echo e((float) ($bookingSettings['min_advance'] ?? 0)); ?>,
                lastOrderAmount: 0,
                ...
                generateAvailableDates() {
                    ...
                    const maxDays = <?php echo e($bookingSettings['advance_days']); ?>;
...
<?php /**PATH /Users/akash/Downloads/clinicos-main/backend/resources/views/public/booking.blade.php ENDPATH**/ ?>