...
<?php $__env->startSection('subtitle', 'Overview of your ClinicOS platform'); ?>
...
<div class="space-y-6">
        ...
        <div class="bg-white rounded-2xl p-6 shadow-sm border border-slate-100 card-hover">
            <div class="flex items-start justify-between">
                <div>
                    ...
                    <p class="text-3xl font-display font-bold text-slate-900 mt-2"><?php echo e(number_format($stats['total_clinics'])); ?></p>
        ...
        <div class="bg-white rounded-2xl p-6 shadow-sm border border-slate-100 card-hover">
            <div class="flex items-start justify-between">
                <div>
                    ...
                    <p class="text-3xl font-display font-bold text-slate-900 mt-2"><?php echo e(number_format($stats['total_users'])); ?></p>
        ...
        <div class="bg-white rounded-2xl p-6 shadow-sm border border-slate-100 card-hover">
            <div class="flex items-start justify-between">
                <div>
                    ...
                    <p class="text-3xl font-display font-bold text-slate-900 mt-2"><?php echo e(number_format($stats['total_patients'])); ?></p>
                    <p class="mt-3 text-xs text-slate-500"><?php echo e(number_format($stats['total_appointments'])); ?> appointments</p>
                </div>
        ...
        <div class="bg-white rounded-2xl p-6 shadow-sm border border-slate-100 card-hover">
            <div class="flex items-start justify-between">
                <div>
                    ...
                    <p class="text-3xl font-display font-bold text-slate-900 mt-2">₹<?php echo e(number_format($stats['this_month_revenue'])); ?></p>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="bg-white rounded-2xl p-6 shadow-sm border border-slate-100">
            ...
            <div class="space-y-4">
                ...
                ?>
                <?php $__currentLoopData = $plans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php 
                    ...
                    <div>
                        <div class="flex items-center justify-between mb-2">
                            <div class="flex items-center gap-2">
                                <span class="w-3 h-3 rounded-full <?php echo e($style['bg']); ?>"></span>
                        ...
                        <div class="w-full h-2 <?php echo e($style['light']); ?> rounded-full overflow-hidden">
                            <div class="<?php echo e($style['bg']); ?> h-full rounded-full transition-all duration-500" style="width: <?php echo e($percentage); ?>%"></div>
                        </div>
                    </div>
    ...
    <div class="grid grid-cols-2 gap-6">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100">
            <div class="px-6 py-4 border-b border-gray-100 flex items-center justify-between">
                ...
                <a href="<?php echo e(route('admin.clinics.index')); ?>" class="text-sm text-indigo-600 hover:text-indigo-700">View All</a>
            </div>
            <div class="divide-y divide-gray-100">
                <?php $__empty_1 = true; $__currentLoopData = $recentClinics; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $clinic): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="px-6 py-4 flex items-center justify-between hover:bg-gray-50">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <p class="text-sm font-medium text-gray-900"><?php echo e($clinic->name); ?></p>
                            <p class="text-xs text-gray-500"><?php echo e($clinic->owner?->name ?? 'No owner'); ?></p>
                        </div>
                    </div>
                    <div class="text-right">
                        ...
                        <p class="text-xs text-gray-500 mt-1"><?php echo e($clinic->created_at->diffForHumans()); ?></p>
                    </div>
                </div>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100">
            ...
            <div class="divide-y divide-gray-100">
                <?php $__empty_1 = true; $__currentLoopData = $expiringSoon; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $clinic): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="px-6 py-4 flex items-center justify-between hover:bg-gray-50">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <p class="text-sm font-medium text-gray-900"><?php echo e($clinic->name); ?></p>
                            <p class="text-xs text-gray-500"><?php echo e($clinic->owner?->email ?? 'N/A'); ?></p>
                        </div>
                    </div>
                    <div class="text-right">
                        <p class="text-sm font-medium text-amber-600"><?php echo e($clinic->trial_ends_at->diffForHumans()); ?></p>
                        <a href="<?php echo e(route('admin.clinics.show', $clinic)); ?>" class="text-xs text-indigo-600 hover:underline">View</a>
                    </div>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                <div class="px-6 py-8 text-center text-gray-500">
    ...
    <div class="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
        ...
        <div class="flex gap-4">
            <a href="<?php echo e(route('admin.clinics.create')); ?>" class="flex items-center gap-3 px-5 py-3 bg-indigo-50 hover:bg-indigo-100 rounded-xl transition-colors">
            ...
            <a href="<?php echo e(route('admin.users.create')); ?>" class="flex items-center gap-3 px-5 py-3 bg-blue-50 hover:bg-blue-100 rounded-xl transition-colors">
            ...
            <a href="<?php echo e(route('admin.clinics.index')); ?>?status=expired" class="flex items-center gap-3 px-5 py-3 bg-amber-50 hover:bg-amber-100 rounded-xl transition-colors">
                ...
                <div>
                    ...
                    <p class="text-xs text-gray-500"><?php echo e($stats['expired_trials']); ?> clinics</p>
                </div>
            </a>
        </div>
    </div>
...
<script>
    ...
    new Chart(ctx, {
        type: 'bar',
        data: {
            labels: <?php echo json_encode(collect($monthlySignups)->pluck('month')); ?>,
            datasets: [{
                label: 'New Clinics',
                data: <?php echo json_encode(collect($monthlySignups)->pluck('count')); ?>,
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/akash/Downloads/clinicos-main/backend/resources/views/admin/dashboard.blade.php ENDPATH**/ ?>