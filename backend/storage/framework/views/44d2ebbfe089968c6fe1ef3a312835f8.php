<?php $__env->startSection('title', 'Users & Staff'); ?>
<?php $__env->startSection('breadcrumb', 'Users & Staff'); ?>
...
<div class="p-6">
    ...
    <div class="flex items-center justify-between mb-6">
        ...
        <a href="<?php echo e(route('clinic.users.create')); ?>" class="inline-flex items-center gap-2 px-4 py-2.5 bg-blue-600 hover:bg-blue-700 text-white text-sm font-semibold rounded-xl transition-colors shadow-sm">
    ...
    <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 mb-6">
        ...
        <div class="bg-white rounded-xl p-4 border border-gray-100">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <p class="text-2xl font-bold text-gray-900"><?php echo e($stats['receptionists']); ?></p>
        ...
        <div class="bg-white rounded-xl p-4 border border-gray-100">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <p class="text-2xl font-bold text-gray-900"><?php echo e($stats['nurses']); ?></p>
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-gray-50 transition-colors">
                        <td class="px-6 py-4">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-gray-500"><?php echo e($user->specialty); ?></p>
                                    <?php endif; ?>
                                </div>
                            </div>
                        </td>
                        ...
                        <td class="px-6 py-4 text-right">
                            <div class="flex items-center justify-end gap-1" x-data="{ showDeleteModal: false }">
                                ...
                                <a href="<?php echo e(route('clinic.users.edit', $user)); ?>" class="p-2 text-gray-500 hover:text-blue-600 hover:bg-blue-50 rounded-lg transition-colors" title="Edit">
                                ...
                                <form action="<?php echo e(route('clinic.users.toggle-status', $user)); ?>" method="POST" class="inline">
                                    <?php echo csrf_field(); ?>
                                    ...
                                    <div class="relative bg-white rounded-2xl shadow-xl p-6 max-w-md mx-4" @click.stop>
                                        <div class="text-center">
                                            ...
                                            <p class="text-sm text-gray-600 mb-6">
                                                Are you sure you want to delete <strong><?php echo e($user->name); ?></strong>? This action cannot be undone.
                                            </p>
                                            <div class="flex gap-3 justify-center">
                                                ...
                                                <form action="<?php echo e(route('clinic.users.destroy', $user)); ?>" method="POST" class="inline">
                                                    <?php echo csrf_field(); ?>
                                ...
                                <span class="text-xs text-gray-400 px-2">
                                    <?php if($user->id === auth()->id()): ?> (You) <?php else: ?> <?php endif; ?>
                                </span>
                                <?php endif; ?>
                            </div>
                        </td>
                    ...
                    <tr>
                        <td colspan="6" class="px-6 py-12 text-center">
                            ...
                            <a href="<?php echo e(route('clinic.users.create')); ?>" class="text-sm text-blue-600 hover:text-blue-700 font-medium">Add your first team member</a>
                        </td>
                    </tr>
                    <?php endif; ?>
                </tbody>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/akash/Downloads/clinicos-main/backend/resources/views/clinic-users/index.blade.php ENDPATH**/ ?>