<?php $__env->startSection('title', 'Custom EMR Builder'); ?>

<?php $__env->startSection('content'); ?>
<?php if(isset($emrBuilderSchemaReady) && !$emrBuilderSchemaReady): ?>
...
<div x-data="emrBuilder()" class="flex" @keydown.escape="selectedField = null">
    ...
    <div class="builder-sidebar p-4">
        ...
        <div class="space-y-2">
            <?php $__currentLoopData = $fieldTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type => $info): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="field-type" draggable="true" @dragstart="dragField('<?php echo e($type); ?>', $event)">
                <span class="text-xl"><?php echo e($info['icon']); ?></span>
                <span class="text-sm font-medium text-gray-700"><?php echo e($info['label']); ?></span>
            </div>
        ...
        <div class="bg-white rounded-xl w-full max-w-4xl max-h-[90vh] overflow-hidden" @click.away="showTemplatesModal = false">
            ...
            <div class="p-6 overflow-y-auto max-h-[calc(90vh-140px)]">
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div class="template-card" :class="{ 'active': editingTemplateId === <?php echo e($template->id); ?> }" @click="loadTemplate(<?php echo e(json_encode($template)); ?>)">
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    <div class="font-medium text-gray-900"><?php echo e($template->name); ?></div>
                                    <div class="text-sm text-gray-500"><?php echo e($template->specialty ?? 'All specialties'); ?> • v<?php echo e($template->version); ?></div>
                                </div>
                            </div>
                            <div class="flex items-center gap-1">
                                <button @click.stop="duplicateTemplate(<?php echo e($template->id); ?>)" class="p-2 hover:bg-gray-100 rounded text-gray-500">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 16H6a2 2 0 01-2-2V6a2 2 0 012-2h8a2 2 0 012 2v2"/>
                                    </svg>
                                </button>
                                <button @click.stop="deleteTemplate(<?php echo e($template->id); ?>)" class="p-2 hover:bg-red-50 rounded text-red-500">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"/>
                                    </svg>
                                </button>
...
<script>
function emrBuilder() {
    const fieldTypes = <?php echo json_encode($fieldTypes, 15, 512) ?>;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/akash/Downloads/clinicos-main/backend/resources/views/emr/builder.blade.php ENDPATH**/ ?>