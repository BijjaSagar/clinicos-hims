<?php $__env->startSection('title', 'OPD Queue Management'); ?>
...
<div
    ...
    x-data="{
        ...
        currentTime: '',
        refreshCountdown: 30,
        doctorFilter: '<?php echo e(request('doctor_id', '')); ?>',
        init() {
            this.tick();
...
>
    ...
    <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 mb-6">
        ...
        <div class="flex items-center gap-3 flex-wrap">
            ...
            <a href="<?php echo e(route('opd.register', ['date' => $date])); ?>"
    ...
    <div class="flex flex-wrap items-center gap-2 rounded-xl border border-gray-200 bg-white px-4 py-3 text-sm mb-4">
        ...
        <?php if(\Illuminate\Support\Facades\Route::has('ipd.index')): ?>
            <a href="<?php echo e(route('ipd.index')); ?>" class="px-3 py-1.5 rounded-lg font-medium text-slate-700 bg-slate-50 border border-slate-200 hover:bg-slate-100">IPD</a>
        <?php endif; ?>
        <?php if(\Illuminate\Support\Facades\Route::has('laboratory.index')): ?>
            <a href="<?php echo e(route('laboratory.index')); ?>" class="px-3 py-1.5 rounded-lg font-medium text-teal-800 bg-teal-50 border border-teal-100 hover:bg-teal-100">Laboratory</a>
        <?php endif; ?>
        <?php if(\Illuminate\Support\Facades\Route::has('pharmacy.dispense.form')): ?>
            <a href="<?php echo e(route('pharmacy.dispense.form')); ?>" class="px-3 py-1.5 rounded-lg font-medium text-emerald-800 bg-emerald-50 border border-emerald-100 hover:bg-emerald-100">Pharmacy</a>
        <?php endif; ?>
        <?php if(\Illuminate\Support\Facades\Route::has('billing.index')): ?>
            <a href="<?php echo e(route('billing.index')); ?>" class="px-3 py-1.5 rounded-lg font-medium text-blue-800 bg-blue-50 border border-blue-100 hover:bg-blue-100">Billing</a>
        <?php endif; ?>
    </div>

    
    <div class="bg-white rounded-2xl border border-gray-200 shadow-sm p-4 mb-6">
        <form method="GET" action="<?php echo e(route('opd.queue')); ?>" class="flex flex-col sm:flex-row items-start sm:items-center gap-3">
            ...
            <div class="flex items-center gap-2">
                ...
                <select name="doctor_id"
                    ...
                    <?php $__currentLoopData = $doctors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $doctor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($doctor->id); ?>" <?php echo e(request('doctor_id') == $doctor->id ? 'selected' : ''); ?>><?php echo e($doctor->name); ?></option>
            ...
            <?php if($date !== today()->toDateString() || request('doctor_id')): ?>
                <a href="<?php echo e(route('opd.queue')); ?>" class="px-4 py-2 bg-gray-100 text-gray-700 text-sm font-medium rounded-xl hover:bg-gray-200 transition-colors">
                    Reset
                </a>
            <?php endif; ?>
        </form>
        ...
        <div class="bg-white rounded-2xl border border-gray-200 shadow-sm p-4 relative overflow-hidden">
            ...
            <div class="flex items-start justify-between pl-3">
                <div>
                    ...
                    <p class="text-2xl font-extrabold text-gray-900 leading-none"><?php echo e($stats['total']); ?></p>
                </div>
        ...
        <div class="bg-amber-50 rounded-2xl border border-amber-200 shadow-sm p-4 relative overflow-hidden">
            ...
            <div class="flex items-start justify-between pl-3">
                <div>
                    ...
                    <p class="text-2xl font-extrabold text-amber-700 leading-none"><?php echo e($stats['waiting']); ?></p>
                </div>
        ...
        <div class="bg-indigo-50 rounded-2xl border border-indigo-200 shadow-sm p-4 relative overflow-hidden">
            ...
            <div class="flex items-start justify-between pl-3">
                <div>
                    ...
                    <p class="text-2xl font-extrabold text-indigo-700 leading-none"><?php echo e($stats['in_progress']); ?></p>
                </div>
        ...
        <div class="bg-emerald-50 rounded-2xl border border-emerald-200 shadow-sm p-4 relative overflow-hidden">
            ...
            <div class="flex items-start justify-between pl-3">
                <div>
                    ...
                    <p class="text-2xl font-extrabold text-emerald-700 leading-none"><?php echo e($stats['completed']); ?></p>
                </div>
        ...
        <div class="bg-red-50 rounded-2xl border border-red-200 shadow-sm p-4 relative overflow-hidden">
            ...
            <div class="flex items-start justify-between pl-3">
                <div>
                    ...
                    <p class="text-2xl font-extrabold text-red-700 leading-none"><?php echo e($stats['cancelled']); ?></p>
                </div>
    ...
    <div class="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-100 flex items-center justify-between">
            <div class="flex items-center gap-3">
                ...
                <span class="px-2.5 py-0.5 bg-indigo-50 text-indigo-700 text-xs font-semibold rounded-full"><?php echo e($stats['total']); ?> patients</span>
            </div>
            <span class="text-xs text-gray-400"><?php echo e(\Carbon\Carbon::parse($date)->format('D, d M Y')); ?></span>
        </div>
        <div class="overflow-x-auto">
            <table class="w-full min-w-[900px]">
                ...
                <tbody class="divide-y divide-gray-100">
                    <?php $__empty_1 = true; $__currentLoopData = $appointments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $appt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <?php
                        $statusColors = [
                    ...
                    ?>
                    <tr class="hover:bg-blue-50/30 transition-colors group <?php echo e($isEmergency ? 'border-l-4 border-l-red-500 bg-red-50/30' : ''); ?>">
                        <td class="px-4 py-4">
                            <span class="inline-flex items-center justify-center min-w-[2.5rem] px-1 h-10 bg-indigo-100 text-indigo-700 font-extrabold text-base rounded-xl shadow-sm">
                                <?php echo e($appt->token_number ?? str_pad($index + 1, 2, '0', STR_PAD_LEFT)); ?>
                        ...
                        <td class="px-4 py-4">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    <p class="text-sm font-semibold text-gray-900 group-hover:text-indigo-700 transition-colors"><?php echo e($appt->patient->name ?? 'Unknown'); ?></p>
                                    <p class="text-xs text-gray-400 mt-0.5">
                                        <?php echo e($appt->patient->phone ?? ''); ?>

                                        <?php if($appt->patient->age ?? null): ?>
                                            &middot; <?php echo e($appt->patient->age); ?> yrs
                                        <?php endif; ?>
                                        <?php if($appt->patient->gender ?? null): ?>
                                            / <?php echo e(ucfirst(substr($appt->patient->gender, 0, 1))); ?>
                        ...
                        <td class="px-4 py-4">
                            <p class="text-sm text-gray-800 font-medium"><?php echo e($appt->doctor->name ?? '—'); ?></p>
                        </td>
                        <?php if(\Illuminate\Support\Facades\Schema::hasColumn('appointments', 'opd_department')): ?>
                        <td class="px-4 py-4 max-w-[180px]">
                            <form method="POST" action="<?php echo e(route('opd.department', $appt)); ?>" class="flex gap-1 items-center">
                                <?php echo csrf_field(); ?>
                                <input type="text" name="opd_department" value="<?php echo e($appt->opd_department); ?>" class="w-full min-w-0 text-xs border border-gray-200 rounded-lg px-2 py-1.5" placeholder="Dept">
                        ...
                        <td class="px-4 py-4 whitespace-nowrap">
                            <p class="text-sm text-gray-800 font-medium">
                                <?php echo e($appt->scheduled_at ? $appt->scheduled_at->format('h:i A') : '—'); ?>

                            </p>
                        </td>
                        <td class="px-4 py-4 max-w-[200px]">
                            <p class="text-sm text-gray-600 truncate" title="<?php echo e($appt->chief_complaint); ?>"><?php echo e($appt->chief_complaint ?? '—'); ?></p>
                        </td>
                        <td class="px-4 py-4 text-center">
                            <?php if($waitTime): ?>
                                <span class="inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-xs font-semibold <?php echo e(($waitMinutes ?? 0) > 30 ? 'bg-red-100 text-red-700' : (($waitMinutes ?? 0) > 15 ? 'bg-amber-100 text-amber-700' : 'bg-green-100 text-green-700')); ?>">
                                    <svg class="w-3 h-3" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M12 8v4l3 3"/>
                                    </svg>
                                    <?php echo e($waitMinutes); ?>m
                                </span>
                            <?php elseif(in_array($appt->status, ['completed', 'cancelled', 'no_show'])): ?>
                        ...
                        <td class="px-4 py-4 text-center">
                            <select
                                onchange="
                                    const apptId = '<?php echo e($appt->id); ?>';
                                ...
                                "
                                class="text-xs font-semibold px-3 py-1.5 rounded-full border-0 cursor-pointer focus:ring-2 focus:ring-indigo-500/30 appearance-none <?php echo e($colorClass); ?>"
                            >
                                <option value="booked" <?php echo e($appt->status === 'booked' ? 'selected' : ''); ?>>Booked</option>
                                <option value="confirmed" <?php echo e($appt->status === 'confirmed' ? 'selected' : ''); ?>>Waiting</option>
                                <option value="checked_in" <?php echo e($appt->status === 'checked_in' ? 'selected' : ''); ?>>Checked in</option>
                                <option value="in_consultation" <?php echo e($appt->status === 'in_consultation' ? 'selected' : ''); ?>>In consultation</option>
                                ...
                                <option value="no_show" <?php echo e($appt->status === 'no_show' ? 'selected' : ''); ?>>No show</option>
                                <option value="rescheduled" <?php echo e($appt->status === 'rescheduled' ? 'selected' : ''); ?>>Rescheduled</option>
                            </select>
                        </td>
                        <td class="px-4 py-4 text-center">
                            <div class="flex items-center justify-center gap-1.5">
                                ...
                                ?>
                                <?php if(($appt->patient_id ?? null) && $appt->status === 'in_consultation' && $vRow): ?>
                                    <a href="<?php echo e(route('emr.show', [$appt->patient_id, $vRow->id])); ?>"
                                ...
                                <?php elseif(($appt->patient_id ?? null) && in_array($appt->status, ['booked', 'confirmed', 'checked_in'], true)): ?>
                                    <form action="<?php echo e(route('emr.create', $appt->patient_id)); ?>" method="POST" class="inline">
                                        <?php echo csrf_field(); ?>
                                        <?php if(!empty($appt->specialty)): ?>
                                            <input type="hidden" name="specialty" value="<?php echo e($appt->specialty); ?>">
                                        <?php endif; ?>
                                        <button type="submit"
                                            class="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-semibold text-white bg-indigo-600 rounded-lg hover:bg-indigo-700 transition-colors shadow-sm whitespace-nowrap">
                                            <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                                ...
                                <?php endif; ?>
                                <?php if($appt->patient_id ?? null): ?>
                                    <a href="<?php echo e(route('patients.show', $appt->patient_id)); ?>"
    ...
    <div x-show="walkinOpen" x-cloak class="fixed inset-0 z-50 flex items-center justify-center p-4" @keydown.escape.window="walkinOpen = false; refreshCountdown = 30">
        ...
        <div class="relative bg-white rounded-2xl shadow-2xl w-full max-w-lg" @click.stop
            ...
            <form method="POST" action="<?php echo e(route('opd.walkin')); ?>" class="p-6 space-y-4">
                <?php echo csrf_field(); ?>
                <div>
                    ...
                    <select name="patient_id" required
                        ...
                        <?php $__currentLoopData = $patients ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $patient): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($patient->id); ?>"><?php echo e($patient->name); ?> (<?php echo e($patient->phone ?? 'No phone'); ?>)</option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                    <p class="mt-2 text-xs text-gray-500">
                        New patient?
                        <a href="<?php echo e(route('patients.create', ['return_to' => route('opd.queue')])); ?>" class="font-semibold text-emerald-600 hover:underline">Register patient</a>
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="date" name="appointment_date" value="<?php echo e($date); ?>" required
                            class="w-full px-3 py-2.5 border border-gray-300 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500/30 focus:border-emerald-500 transition-colors">
                    </div>
                    <div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/akash/Downloads/clinicos-main/backend/resources/views/opd/queue.blade.php ENDPATH**/ ?>