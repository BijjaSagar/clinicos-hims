<?php $__env->startSection('title', 'Lab Integration'); ?>
...
<div x-data='labDashboard(<?php echo json_encode($labDashboardInit, 15, 512) ?>)' class="p-6 space-y-6">
    <?php if(isset($labSchemaReady) && !$labSchemaReady): ?>
    ...
    <div class="flex flex-wrap items-center gap-2 rounded-xl border border-gray-200 bg-white px-4 py-3 text-sm">
        ...
        <?php if(\Illuminate\Support\Facades\Route::has('opd.queue')): ?>
            <a href="<?php echo e(route('opd.queue')); ?>" class="px-3 py-1.5 rounded-lg font-medium text-indigo-700 bg-indigo-50 hover:bg-indigo-100 border border-indigo-100">OPD Queue</a>
        <?php endif; ?>
        <?php if(\Illuminate\Support\Facades\Route::has('ipd.index')): ?>
            <a href="<?php echo e(route('ipd.index')); ?>" class="px-3 py-1.5 rounded-lg font-medium text-slate-700 bg-slate-50 hover:bg-slate-100 border border-slate-200">IPD</a>
        <?php endif; ?>
        <?php if(\Illuminate\Support\Facades\Route::has('laboratory.orders')): ?>
            <a href="<?php echo e(route('laboratory.orders')); ?>" class="px-3 py-1.5 rounded-lg font-medium text-teal-800 bg-teal-50 hover:bg-teal-100 border border-teal-100">In-house lab orders</a>
        <?php endif; ?>
        <?php if(\Illuminate\Support\Facades\Route::has('pharmacy.dispense.form')): ?>
            <a href="<?php echo e(route('pharmacy.dispense.form')); ?>" class="px-3 py-1.5 rounded-lg font-medium text-emerald-800 bg-emerald-50 hover:bg-emerald-100 border border-emerald-100">Pharmacy</a>
        <?php endif; ?>
        <?php if(\Illuminate\Support\Facades\Route::has('billing.index')): ?>
            <a href="<?php echo e(route('billing.index')); ?>" class="px-3 py-1.5 rounded-lg font-medium text-blue-800 bg-blue-50 hover:bg-blue-100 border border-blue-100">Billing</a>
        <?php endif; ?>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div class="bg-white rounded-xl border border-gray-200 p-6">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <div class="text-2xl font-bold text-gray-900"><?php echo e($stats['orders_today']); ?></div>
        ...
        <div class="bg-white rounded-xl border border-gray-200 p-6">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <div class="text-2xl font-bold text-gray-900"><?php echo e($stats['pending_results']); ?></div>
        ...
        <div class="bg-white rounded-xl border border-gray-200 p-6">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <div class="text-2xl font-bold text-gray-900"><?php echo e($stats['results_received']); ?></div>
    ...
    <div class="bg-white rounded-xl border border-gray-200 overflow-hidden">
        ...
        <div class="p-6">
            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
                <?php if(\Illuminate\Support\Facades\Route::has('laboratory.orders')): ?>
                <a href="<?php echo e(route('laboratory.orders')); ?>" class="border-2 border-teal-400 bg-teal-50/50 rounded-lg p-4 text-center hover:bg-teal-50 transition-colors ring-1 ring-teal-200">
                ...
                <div class="border border-gray-200 rounded-lg p-4 text-center hover:border-teal-300 transition-colors cursor-pointer" @click="selectProvider('<?php echo e($lab['code']); ?>')">
                    <div class="w-12 h-12 mx-auto rounded-lg <?php echo e($lab['color']); ?> flex items-center justify-center text-white font-bold text-sm mb-2">
                        <?php echo e(substr($lab['name'], 0, 2)); ?>
            ...
            <table class="w-full">
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-gray-50">
                        <td class="px-4 py-3">
                            <span class="font-mono text-sm font-medium text-teal-600"><?php echo e($order->order_number); ?></span>
                        </td>
                        <td class="px-4 py-3 font-medium text-gray-900"><?php echo e($order->patient_name); ?></td>
                        <td class="px-4 py-3 text-sm text-gray-600"><?php echo e($order->provider_name); ?></td>
                        <td class="px-4 py-3">
                            <?php $tests = json_decode($order->tests, true) ?? []; ?>
                            <span class="text-sm text-gray-600"><?php echo e(count($tests)); ?> tests</span>
                        </td>
                        <td class="px-4 py-3 font-medium text-gray-900">₹<?php echo e(number_format($order->total_amount)); ?></td>
                        <td class="px-4 py-3">
                            <?php
                                $statusColors = [
                            ...
                            ?>
                            <span class="px-2 py-1 text-xs font-medium rounded-full <?php echo e($statusColors[$order->status] ?? 'bg-gray-100'); ?>">
                        ...
                        <td class="px-4 py-3">
                            ...
                            <div class="flex gap-2">
                                <?php if(\Illuminate\Support\Arr::get((array) $order, 'result_url')): ?>
                                <a href="<?php echo e(\Illuminate\Support\Facades\Route::has('lab.orders.download') ? route('lab.orders.download', $order->id) : '/lab/orders/'.$order->id.'/download'); ?>" class="p-2 text-green-600 hover:bg-green-50 rounded-lg" title="Download Result">
                                ...
                                <?php endif; ?>
                                <?php if($labViewUrl): ?>
                                <a href="<?php echo e($labViewUrl); ?>" class="p-2 text-gray-500 hover:text-blue-600 hover:bg-blue-50 rounded-lg" title="<?php echo e($labViewTitle); ?>">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/akash/Downloads/clinicos-main/backend/resources/views/lab/index.blade.php ENDPATH**/ ?>