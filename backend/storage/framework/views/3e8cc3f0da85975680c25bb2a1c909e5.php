...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Admin'); ?> - ClinicOS Admin</title>
...
<body class="bg-gray-50 antialiased" x-data="{ adminMobileNav: false }" x-init="window.addEventListener('resize', () => { if (window.matchMedia('(min-width: 1024px)').matches) adminMobileNav = false })" :class="adminMobileNav ? 'overflow-hidden lg:overflow-auto' : ''">
    ...
    >
        ...
        <p class="text-sm font-medium text-gray-900"><?php echo e(session('success')); ?></p>
    ...
    >
        ...
        <p class="text-sm font-medium text-gray-900"><?php echo e(session('error')); ?></p>
        <button @click="show = false" class="ml-auto text-gray-400 hover:text-gray-600">
            <svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" d="M6 18L18 6M6 6l12 12"/>
            </svg>
    ...
    >
        ...
        <a href="<?php echo e(route('admin.stop-impersonating')); ?>" class="ml-auto px-3 py-1 bg-white text-indigo-600 rounded-lg text-xs font-semibold hover:bg-indigo-50">
            Return to Admin
        </a>
    </div>
    <?php endif; ?>
    ...
    <div class="flex min-h-screen w-full min-w-0 relative">
        ...
        >
            ...
            <nav class="flex-1 px-4 py-2 space-y-1 overflow-y-auto">
                ...
                <a href="<?php echo e(route('admin.clinics.index')); ?>" class="sidebar-link <?php echo e(request()->routeIs('admin.clinics*') ? 'active' : ''); ?>">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24">
                ...
                <a href="<?php echo e(route('admin.whatsapp.index')); ?>" class="sidebar-link <?php echo e(request()->routeIs('admin.whatsapp*') ? 'active' : ''); ?>">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24">
            ...
            <header class="bg-white/80 backdrop-blur-lg border-b border-slate-200/80 sticky top-0 z-30">
                <div class="px-4 sm:px-6 lg:px-8 py-4 sm:py-5 flex items-start sm:items-center justify-between gap-3">
                    <div class="flex items-start gap-3 min-w-0 flex-1">
                        ...
                        <div class="min-w-0">
                        <h2 class="text-lg sm:text-2xl font-display font-bold text-slate-900 truncate"><?php echo $__env->yieldContent('title', 'Dashboard'); ?></h2>
                        <?php if (! empty(trim($__env->yieldContent('subtitle')))): ?>
                            <p class="text-xs sm:text-sm text-slate-500 mt-1 line-clamp-2 sm:line-clamp-none"><?php echo $__env->yieldContent('subtitle'); ?></p>
                        <?php endif; ?>
                        </div>
                    </div>
...
<?php /**PATH /Users/akash/Downloads/clinicos-main/backend/resources/views/admin/layouts/app.blade.php ENDPATH**/ ?>