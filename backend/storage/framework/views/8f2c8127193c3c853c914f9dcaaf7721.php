<?php $__env->startSection('title', 'Smart Scan - Lab Report OCR'); ?>
        ...
        <div class="col-md-6">
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <div class="row g-2">
                        <?php $__currentLoopData = ['Hemoglobin', 'WBC', 'RBC', 'Platelets', 'HbA1c', 'Blood Sugar', 'Creatinine', 'BUN', 'SGPT/ALT', 'SGOT/AST', 'Cholesterol', 'HDL', 'LDL', 'Triglycerides', 'TSH', 'T3/T4', 'Vitamin D', 'Vitamin B12', 'Calcium', 'Sodium', 'Potassium', 'Uric Acid', 'ESR', 'CRP']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $test): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-6"><span class="badge bg-light text-dark border w-100 py-1"><?php echo e($test); ?></span></div>
...
function smartScan() {
    return {
        ...
        async uploadFile() {
            ...
            try {
                const resp = await fetch('<?php echo e(route("smart-scan.upload")); ?>', { method: 'POST', body: fd, headers: { 'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]')?.content || '' } });
...
function textParser() {
    return {
        ...
        async parseText() {
            ...
            this.parsing = true;
            try {
                const resp = await fetch('<?php echo e(route("smart-scan.parse")); ?>', {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/akash/Downloads/clinicos-main/backend/resources/views/smart-scan/index.blade.php ENDPATH**/ ?>