...
<?php $__env->startSection('breadcrumb', 'Schedule'); ?>
...
<div class="schedule-container" x-data="{ view: 'day', showQuickAdd: false }">
    ...
    <div class="schedule-main">
        ...
        <div class="calendar-header">
            <div class="date-nav">
                <a href="<?php echo e(route('schedule', ['date' => $today->copy()->subDay()->toDateString()])); ?>" class="date-nav-btn">
                    <svg style="width:16px;height:16px" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M15.75 19.5L8.25 12l7.5-7.5"/>
                    </svg>
                </a>
                <a href="<?php echo e(route('schedule', ['date' => today()->toDateString()])); ?>" class="date-nav-btn" style="font-size:11px;width:auto;padding:0 10px">Today</a>
                <a href="<?php echo e(route('schedule', ['date' => $today->copy()->addDay()->toDateString()])); ?>" class="date-nav-btn">
                    <svg style="width:16px;height:16px" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
            ...
            <div class="current-date">
                <?php if($today->isToday()): ?>
                    Today, <?php echo e($today->format('d M Y')); ?>

                <?php else: ?>
                    <?php echo e($today->format('l, d M Y')); ?>
            ...
            <div class="resource-filter">
                <?php $__currentLoopData = $doctors->take(4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $doc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <span class="resource-chip active" style="background:<?php echo e(['#1447e6','#059669','#d97706','#dc2626'][$loop->index % 4]); ?>;border-color:<?php echo e(['#1447e6','#059669','#d97706','#dc2626'][$loop->index % 4]); ?>;color:white">
                    <?php echo e(Str::limit($doc->name, 8)); ?>
        ...
        <div class="timeline-grid">
            ...
            <div class="timeline-header">
                ...
                <div class="timeline-header-cell">
                    <div class="resource-name">Dr. <?php echo e($doctor->name); ?></div>
                    <div class="resource-type"><?php echo e($doctor->specialty ?? 'General'); ?></div>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <?php if($rooms->isEmpty() && $doctors->isEmpty()): ?>
                <div class="timeline-header-cell">
            ...
            <div class="timeline-body">
                ...
                <div class="time-column">
                    ...
                    <div class="time-slot"><?php echo e(\Carbon\Carbon::parse($slot)->format('h:i A')); ?></div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
                ...
                <div class="resource-column">
                    <?php $__currentLoopData = $timeSlots; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $slotIndex => $slot): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php
                    ...
                    ?>
                    <div class="slot-row">
                        <?php $__currentLoopData = $slotAppts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $apt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php
                            $duration = $apt->duration_mins ?? 30;
                            $heightMultiplier = $duration / 30;
                        ?>
                        <a href="<?php echo e(route('appointments.show', $apt)); ?>" 
                           class="appointment-card status-<?php echo e($apt->status); ?>"
                           style="height: calc(var(--slot-height) * <?php echo e($heightMultiplier); ?> - 4px);">
                            <div class="apt-time"><?php echo e(\Carbon\Carbon::parse($apt->scheduled_at)->format('h:i A')); ?></div>
                            <div class="apt-patient"><?php echo e($apt->patient->name ?? 'Unknown'); ?></div>
                            <div class="apt-type"><?php echo e(ucfirst($apt->appointment_type ?? 'Consultation')); ?></div>
                            <?php $w = $waitEstimates[$apt->id] ?? null; ?>
                            <?php if($w && ($w['ahead'] ?? 0) > 0): ?>
                            <div class="apt-wait" style="font-size:10px;color:#64748b;margin-top:4px;">~<?php echo e($w['minutes']); ?>m queue (<?php echo e($w['ahead']); ?> ahead)</div>
                            <?php endif; ?>
                        </a>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        
                        <?php if($slotAppts->isEmpty()): ?>
                        <div class="empty-slot" onclick="window.location.href='<?php echo e(route('appointments.create', ['date' => $today->toDateString(), 'time' => $slot, 'doctor' => $doctor->id])); ?>'">+</div>
                        <?php endif; ?>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
    ...
    <div class="schedule-sidebar">
        ...
        <div class="sidebar-card">
            ...
            <div class="stats-grid">
                ...
                <div class="stat-item">
                    <div class="stat-value" style="color:#22c55e"><?php echo e($stats['completed']); ?></div>
                    <div class="stat-label">Completed</div>
                </div>
                <div class="stat-item">
                    <div class="stat-value" style="color:#f59e0b"><?php echo e($stats['in_queue']); ?></div>
                    <div class="stat-label">In Queue</div>
                </div>
                <div class="stat-item">
                    <div class="stat-value" style="color:#ef4444"><?php echo e($stats['cancelled']); ?></div>
        ...
        <div class="sidebar-card">
            <h3>
                ...
                <span style="margin-left:auto;background:#f59e0b;color:white;padding:2px 8px;border-radius:100px;font-size:10px"><?php echo e($queue->count()); ?></span>
                <?php endif; ?>
            </h3>
            
            <div class="queue-list">
                <?php $__empty_1 = true; $__currentLoopData = $queue; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $apt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="queue-item">
                    <div class="queue-token <?php echo e($apt->status === 'checked_in' ? 'waiting' : 'checked-in'); ?>">
                        <?php echo e($apt->token_number ?? $loop->iteration); ?>

                    </div>
                    <div class="queue-info">
                        <div class="queue-name"><?php echo e($apt->patient->name ?? 'Unknown'); ?></div>
                        <div class="queue-time">
                            <?php echo e(\Carbon\Carbon::parse($apt->scheduled_at)->format('h:i A')); ?>

                            <?php if($apt->status === 'in_consultation'): ?>
                                · In consultation
                            <?php else: ?>
                                · Waiting <?php echo e(\Carbon\Carbon::parse($apt->scheduled_at)->diffForHumans()); ?>

                            <?php endif; ?>
                        </div>
                    </div>
                    <?php if($apt->status === 'checked_in'): ?>
                    <form action="<?php echo e(route('appointments.status', $apt)); ?>" method="POST" style="margin:0">
                        <?php echo csrf_field(); ?>
        ...
        <div class="sidebar-card">
            ...
            <div class="room-grid">
                ...
                ?>
                <div class="room-item">
                    <div class="room-indicator <?php echo e($status); ?>"></div>
                    <div class="room-name"><?php echo e($room->name); ?></div>
                    <span class="room-status <?php echo e($status); ?>"><?php echo e(ucfirst($status)); ?></span>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
        </div>
        ...
        <div class="sidebar-card">
            ...
            <div class="room-grid">
                <?php $__currentLoopData = $equipment->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $equip): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="room-item">
                    <div class="room-indicator available"></div>
                    <div class="room-name"><?php echo e($equip->name); ?></div>
...
<a href="<?php echo e(route('appointments.create')); ?>" class="quick-add-btn" title="New Appointment">
    +
</a>
...
console.log('Appointments:', <?php echo e($appointments->count()); ?>);
console.log('Queue:', <?php echo e($queue->count()); ?>);
</script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/akash/Downloads/clinicos-main/backend/resources/views/appointments/index.blade.php ENDPATH**/ ?>