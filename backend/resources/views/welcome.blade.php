...
<nav class="site-nav" aria-label="Primary">
  <div class="nav-inner">
    <a class="logo" href="{{ url('/') }}" aria-label="ClinicOS — Home">
      <img
        class="logo-img"
...
{{-- Backdrop + drawer outside <nav> so fixed positioning uses full viewport (not clipped by nav/backdrop-filter) --}}
...
<div class="nav-drawer" id="navDrawer" role="dialog" aria-modal="true" aria-label="Main menu" aria-hidden="true">
  <div class="nav-drawer-body">
    ...
    <ul class="nav-drawer-links">
      <li><a href="{{ route('public.booking.directory') }}">Book a visit (patients)</a></li>
      <li><a href="#specialties">Specialties</a></li>
      <li><a href="#features">Features</a></li>
      <li><a href="#abdm">ABDM</a></li>
      <li><a href="#pricing">Pricing</a></li>
  ...
  <div class="nav-drawer-foot">
    ...
    <div class="nav-drawer-cta">
      <a href="{{ route('login') }}" class="btn btn-ghost" style="width:100%;justify-content:center;border:1px solid var(--border);background:#fff">Sign in</a>
...
<script>
(function () {
  console.log('[ClinicOS][welcome]', { page: 'marketing', logo: @json(asset('images/clinicos-logo.png')), path: window.location.pathname });
