{{-- Analytics section tabs — active: index | prescriptions | revenue | patients --}}
@php
    $active = $active ?? 'index';
...
<nav class="flex flex-wrap gap-1 sm:gap-2 border-b border-gray-200 mb-6 -mx-1 px-1" aria-label="Analytics sections">
    <a href="{{ route('analytics.index') }}"
       ...
       {{ $active === 'index' ? 'text-brand-blue border-brand-blue bg-white' : 'text-gray-600 border-transparent hover:text-gray-900 hover:border-gray-200' }}">
    ...
    <a href="{{ route('analytics.prescriptions') }}"
       class="inline-flex items-center gap-2 px-3 sm:px-4 py-2.5 text-sm font-semibold rounded-t-lg border-b-2 -mb-px transition-colors whitespace-nowrap
       {{ $active === 'prescriptions' ? 'text-brand-blue border-brand-blue bg-white' : 'text-gray-600 border-transparent hover:text-gray-900 hover:border-gray-200' }}">
    ...
    <a href="{{ route('analytics.revenue') }}"
       class="inline-flex items-center gap-2 px-3 sm:px-4 py-2.5 text-sm font-semibold rounded-t-lg border-b-2 -mb-px transition-colors whitespace-nowrap
       {{ $active === 'revenue' ? 'text-brand-blue border-brand-blue bg-white' : 'text-gray-600 border-transparent hover:text-gray-900 hover:border-gray-200' }}">
    ...
    <a href="{{ route('analytics.patients') }}"
       class="inline-flex items-center gap-2 px-3 sm:px-4 py-2.5 text-sm font-semibold rounded-t-lg border-b-2 -mb-px transition-colors whitespace-nowrap
       {{ $active === 'patients' ? 'text-brand-blue border-brand-blue bg-white' : 'text-gray-600 border-transparent hover:text-gray-900 hover:border-gray-200' }}">
