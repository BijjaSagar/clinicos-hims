...
function endocrinologyEMR() {
    return {
        ...
        formData: @json(($visit ?? null)?->getStructuredField('endocrinology_data') ?? $endocrinologyFormDataDefault),
        commonDiagnoses: [
        ...
        selectedDiagnoses: @json(($visit ?? null)?->getStructuredField('endocrinology_diagnoses') ?? []),
