...
function romSection() {
    ...
    return {
        open: true,
        romData: @json($visit->getStructuredField('physio.rom') ?? $physioRomDefault),
...
function mmtSection() {
    ...
    return {
        open: true,
        mmtData: @json($visit->getStructuredField('physio.mmt') ?? $physioMmtDefault),
...
function treatmentSection() {
    return {
        ...
        modalityParams: @json($visit->getStructuredField('physio.modality_params') ?? new \stdClass()),
