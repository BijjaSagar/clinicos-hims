...
<div x-data="ophthalmologyEMR()" class="ophthal-section">
    ...
    <div class="ophthal-card" style="margin-top: 16px;"
         x-data="{
           systemic: @json(($visit ?? null)?->getStructuredField('ophthal_systemic_data') ?? $ophthalSystemicDefault),
           updateSystemic() {
...
function ophthalmologyEMR() {
    return {
        ...
        vaData: @json(($visit ?? null)?->getStructuredField('ophthal.va') ?? $ophthalVaDefault),
        
        iopData: @json(($visit ?? null)?->getStructuredField('ophthal.iop') ?? $ophthalIopDefault),
        
        refractionData: @json(($visit ?? null)?->getStructuredField('ophthal.refraction') ?? $ophthalRefractionDefault),
        
        slitLampData: @json(($visit ?? null)?->getStructuredField('ophthal.slitLamp') ?? $ophthalSlitLampDefault),
        
        fundusData: @json(($visit ?? null)?->getStructuredField('ophthal.fundus') ?? $ophthalFundusDefault),
        ...
        spectacleRx: @json(($visit ?? null)?->getStructuredField('ophthal.spectacle_rx') ?? $ophthalSpectacleRxDefault),

        contactLensRx: @json(($visit ?? null)?->getStructuredField('ophthal.contact_lens_rx') ?? $ophthalContactLensRxDefault),
