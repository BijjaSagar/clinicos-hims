...
function paediatricsEMR() {
    ...
    return {
        ...
        formData: @json(($visit ?? null)?->getStructuredField('paediatrics_data') ?? $paediatricsFormDataDefault),
        commonDiagnoses: [
        ...
        selectedDiagnoses: @json(($visit ?? null)?->getStructuredField('paediatrics_diagnoses') ?? []),
        get growthNote() {
