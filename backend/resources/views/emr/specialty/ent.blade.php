...
function entEMR() {
    return {
        ...
        earData: @json($visit->getStructuredField('ent.ear') ?? $entEarDefault),
        
        noseData: @json($visit->getStructuredField('ent.nose') ?? $entNoseDefault),
        
        throatData: @json($visit->getStructuredField('ent.throat') ?? $entThroatDefault),
        
        larynxData: @json($visit->getStructuredField('ent.larynx') ?? $entLarynxDefault),
