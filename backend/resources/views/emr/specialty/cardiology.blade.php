...
function cardiologyEMR() {
    return {
        ...
        formData: @json(($visit ?? null)?->getStructuredField('cardiology_data') ?? $cardiologyFormDataDefault),
        nyhaClasses: [
        ...
        selectedDiagnoses: @json(($visit ?? null)?->getStructuredField('cardiology_diagnoses') ?? []),
