...
function psychiatryEMR() {
    return {
        ...
        formData: @json(($visit ?? null)?->getStructuredField('psychiatry_data') ?? $psychiatryFormDataDefault),
        commonDiagnoses: [
        ...
        selectedDiagnoses: @json(($visit ?? null)?->getStructuredField('psychiatry_diagnoses') ?? []),
        get cageScore() {
