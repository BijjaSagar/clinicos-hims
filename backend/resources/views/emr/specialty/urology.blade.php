...
function urologyEMR() {
    return {
        ...
        formData: @json(($visit ?? null)?->getStructuredField('urology_data') ?? $urologyFormDataDefault),
        commonDiagnoses: [
        ...
        selectedDiagnoses: @json(($visit ?? null)?->getStructuredField('urology_diagnoses') ?? []),
        get ipssTotal() {
            let t = 0;
