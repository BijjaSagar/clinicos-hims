...
function diabetologyEMR() {
    return {
        ...
        formData: @json(($visit ?? null)?->getStructuredField('diabetology_data') ?? $diabetologyFormDataDefault),
        commonDiagnoses: [
        ...
        selectedDiagnoses: @json(($visit ?? null)?->getStructuredField('diabetology_diagnoses') ?? []),
        get a1cBigClass() {
