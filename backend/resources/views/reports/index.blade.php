        ...
        <div class="col-md-4">
            <div class="card shadow-sm h-100">
                <div class="card-body text-center">
                    ...
                    <a href="{{ route('reports.daily-summary') }}" class="btn btn-primary btn-sm w-100">View Report</a>
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card shadow-sm h-100">
                <div class="card-body text-center">
                    ...
                    <a href="{{ route('reports.monthly-mis') }}" class="btn btn-success btn-sm w-100">View Report</a>
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card shadow-sm h-100">
                <div class="card-body text-center">
                    ...
                    <div class="btn-group w-100">
                        <a href="{{ route('reports.export-csv', ['type' => 'patient_register']) }}" class="btn btn-outline-info btn-sm">Patients</a>
                        <a href="{{ route('reports.export-csv', ['type' => 'appointment_register']) }}" class="btn btn-outline-info btn-sm">Appointments</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="card shadow-sm h-100">
                <div class="card-body text-center">
                    ...
                    <a href="{{ route('analytics.revenue') }}" class="btn btn-warning btn-sm w-100">View</a>
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card shadow-sm h-100">
                <div class="card-body text-center">
                    ...
                    <a href="{{ route('analytics.prescriptions') }}" class="btn btn-danger btn-sm w-100">View</a>
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card shadow-sm h-100">
                <div class="card-body text-center">
                    ...
                    <a href="{{ route('analytics.patients') }}" class="btn btn-secondary btn-sm w-100">View</a>
                </div>
            </div>
        </div>
    </div>
